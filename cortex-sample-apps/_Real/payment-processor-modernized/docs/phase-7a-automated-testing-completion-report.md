...
**Location:** `tests/PaymentProcessor.TransactionInvoices.UnitTests/FeatureManagement/`  
**Lines:** 204  
...
**Location:** `tests/PaymentProcessor.TransactionInvoices.UnitTests/Monitoring/`  
**Lines:** 168  
...
**Location:** `tests/PaymentProcessor.TransactionInvoices.IntegrationTests/FeatureManagement/`  
**Lines:** 120  
...
**Location:** `tests/PaymentProcessor.TransactionInvoices.IntegrationTests/Monitoring/`  
**Lines:** 119  
...
```
tests/
├── PaymentProcessor.TransactionInvoices.UnitTests/
│   ├── FeatureManagement/
...
└── PaymentProcessor.TransactionInvoices.IntegrationTests/
    ├── FeatureManagement/
