...
public class TypeSafetyValidationTests : IDisposable
{
    ...
    private readonly MockTransactionInvoiceRepository _mockRepository;
    ...
    public TypeSafetyValidationTests()
    {
        ...
        _mockRepository = new MockTransactionInvoiceRepository();
    }

    [Fact]
    public async Task MockTransactionInvoice_DecimalPrecision_MustMatchDatabase()
    {
        // Arrange
        ...
        var amountProperty = dbEntityType?.FindProperty(nameof(TransactionInvoice.Amount));
        ...
        var result = _validator.ValidateDecimalPrecision(
            mockInvoice!.Amount,
            amountProperty!,
            nameof(TransactionInvoice.Amount));
    ...
    [Fact]
    public async Task AllMockTransactionInvoices_DecimalFields_MustFitDatabaseConstraints()
    {
        // Arrange
        ...
        foreach (var invoice in mockInvoices)
        {
            ...
            {
                var propertyInfo = typeof(TransactionInvoice).GetProperty(property.Name);
    ...
    [Fact]
    public async Task MockTransactionInvoice_StringFields_MustNotExceedMaxLength()
    {
        // Arrange
        var mockInvoices = await _mockRepository.GetAllAsync();
        var dbEntityType = _dbContext.Model.FindEntityType(typeof(TransactionInvoice));
    ...
    [Fact]
    public async Task MockTransactionInvoice_DateTimeFields_MustBeWithinSqlServerRange()
    {
        // Arrange
        var mockInvoices = await _mockRepository.GetAllAsync();
        var dbEntityType = _dbContext.Model.FindEntityType(typeof(TransactionInvoice));
    ...
    private class MockDecimalProperty : Microsoft.EntityFrameworkCore.Metadata.IProperty
    {
        ...
        // Implement required IProperty customers (minimal for testing)
