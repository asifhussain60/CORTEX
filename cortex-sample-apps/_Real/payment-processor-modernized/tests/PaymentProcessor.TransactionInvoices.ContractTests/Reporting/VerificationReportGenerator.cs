...
namespace PaymentProcessor.TransactionInvoices.ContractTests.Reporting;
...
public class VerificationReportGenerator
{
    ...
    private string GenerateExecutiveSummary()
    {
        ...
        sb.AppendLine($"    <p><strong>Migration Project:</strong> PaymentProcessor Transaction Invoices (Product.PaymentProcessor.Api)</p>");
        sb.AppendLine($"    <p><strong>Verification Duration:</strong> {_report.Duration:hh\\:mm\\:ss}</p>");
        sb.AppendLine();
        sb.AppendLine("    <h2>Executive Summary</h2>");
        sb.AppendLine("    <p>");
        sb.AppendLine($"        This report documents the contract verification results for Phase 4a of the PaymentProcessor Transaction Invoices migration.");
    ...
    public async Task GenerateMarkdownSummaryAsync(string outputPath)
    {
        ...
        sb.AppendLine($"**Migration Project:** PaymentProcessor Transaction Invoices (Product.PaymentProcessor.Api)  ");
