...
### 1. ExampleDomainService.cs
- **Location:** `Domain/Services/`
- **Size:** 717 LOC
- **Complexity:** HIGH (20+ methods)
- **Why Critical:** RegulatoryAgency compliance, $500k penalty risk
- **Read Time:** 45 min
...
### 4. Plan.cs
- **Purpose:** Core domain model (FlexAccount/HealthSavings/HealthReimbursement)
- **Key Properties:** PlanType, CarryoverEnabled, ContributionLimits
- **Read Time:** 20 min

### 5. Participant.cs
- **Purpose:** User account model
- **Key Relations:** Plans, Balances, Requests
- **Read Time:** 15 min

### 6. CarryoverDollars.cs
- **Purpose:** Rollover entity
- **Key Logic:** RegulatoryAgency limit validation
- **Read Time:** 15 min
...
- **Purpose:** RegulatoryAgency contribution/rollover limits
- **Annual Updates:** YES (update every January)
- **Read Time:** 10 min

### 14. QualifiedExpenseValidator.cs
- **Purpose:** RegulatoryAgency Pub 502 expense validation
- **Read Time:** 15 min

### 15. HipaaAuditLogger.cs
- **Purpose:** PHI access logging
- **Compliance:** PrivacyRegulation §164.312
- **Read Time:** 10 min
...
### 19. appsettings.json
- **Purpose:** Configuration (DB, NServiceBus, RegulatoryAgency limits)
- **Read Time:** 5 min
...
3. ExampleDomainService.cs (45 min)
