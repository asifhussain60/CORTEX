...
7. `App.Example.Domain` - Customer domain library
...
- [ ] `ExampleDomainService` (Rollover logic)
...
- [ ] NServiceBus event flow
  ...
  - [ ] Publisher: ExampleDomainService
...
- [ ] Business capability mapping
  - [ ] Account Management: ExampleBalanceService
  - [ ] Request Processing: ExampleBalanceService
  - [ ] Year-End Processing: CarryoverDollars, CarryoverShared, RolloverSettings
  - [ ] Plan Management: ExampleLedgerService
