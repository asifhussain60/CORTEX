...
Level 6-7: Deep API client generation (App.Customer.Domain/Clients/Requests/Generated/V1/Requests/)
```

### Deepest Paths (7 levels)
**All in App.Customer.Domain library - Auto-generated API clients:**
```
Libs/App.Customer.Domain/Clients/Requests/Generated/
Libs/App.Customer.Domain/Clients/Requests/OpenApi/
Libs/App.Customer.Domain/Clients/Requests/Generated/Models/
Libs/App.Customer.Domain/Clients/Requests/Generated/V1/
Libs/App.Customer.Domain/Clients/Requests/Generated/V1/Requests/
```
...
| **Product.PaymentAccounts** | 10 | Root project files |
...
```python
SCAN_ORDER = [
    ("*.csproj", "METADATA_FRegulatoryAgencyT"),  # 12 files - dependency graph
...
3. **Proceed with Batch 2** (Complete Business Domain - 90 min):
   ...
   - Map functional areas beyond Rollover
