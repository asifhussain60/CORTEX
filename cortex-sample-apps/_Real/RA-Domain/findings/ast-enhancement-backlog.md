...
The current CORTEX AST analysis toolkit is **Python-specific** using the `ast` module. The Payment Accounts (RA) domain analysis revealed the need for **C# AST capabilities** to analyze .NET codebases. This document outlines **52+ enhancements** needed to support multi-language analysis.
  ...
  "properties": [
    {
      ...
      "xml_doc": "Unique identifier for organization"
    },
    {
      "name": "CompanyName",
      "type": "string",
...
```json
{
  ...
  "navigation_properties": [
    {
      "name": "Customers",
      "type": "ICollection<Customer>",
      "relationship": "OneToMany",
      "inverse_property": "Organization"
    },
    {
      "name": "ReimbursementPlans",
      "type": "ICollection<PaymentPlan>",
      "relationship": "OneToMany",
      "inverse_property": "Organization"
    }
  ]
...
**Use Case:** Extract RegulatoryAgency rollover calculation logic from `CalculateCarryoverAmountAllowedAtPlanYearEnd`
...
```json
{
  ...
  "type": "enum",
  "members": [
    {"name": "FlexAccount", "value": 0},
    {"name": "HealthSavings", "value": 1},
    {"name": "HealthReimbursement", "value": 2},
