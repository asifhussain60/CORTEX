...
| Metric | Value | Impact |
|--------|-------|--------|
| **Root Path** | `C:\PROJECTS\Product.Example` | - |
...
| **Library Projects** | 2 (Libs folder) | App.Example.Domain, GenericCorp.Abstractions |
...
- [ ] Find `ExampleDomainService.cs` file
...
# AST scan: Apps/*/ExampleDomainService.cs
```
...
- [ ] Extract ExampleDomainService (HIGH PRIORITY)
...
**Execution Command:**
```powershell
cd C:\PROJECTS\Product.Example\Apps\App.RolloverTransferTracking.Endpoint
```
...
**Execution Command:**
```powershell
cd C:\PROJECTS\Product.Example\Apps\App.PaymentAccounts.ApplicationServices
```
...
**Execution Command:**
```powershell
cd C:\PROJECTS\Product.Example\Tests
```
