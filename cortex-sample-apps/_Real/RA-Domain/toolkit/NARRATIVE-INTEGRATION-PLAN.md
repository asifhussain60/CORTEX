...
| **regulatory/compliance-overview.html** | Regulatory Framework Summary | RegulatoryAgency/PrivacyRegulation/PaymentSecurity context | 300 words | 🟠 HIGH |
...
<section class="glass-card-flat mb-xl">
    ...
    <div class="narrative-content">
        <div class="narrative-preview" id="narrative-preview">
            ...
            <p>The Payment Accounts platform is GenericCorp's enterprise system...</p>
            <!-- ... -->
        </div>
