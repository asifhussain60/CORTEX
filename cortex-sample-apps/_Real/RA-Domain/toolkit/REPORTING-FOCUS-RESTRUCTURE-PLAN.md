...
**KEEP:**
- Test coverage: 8.6%
- Bus factor: 1 person (Rollover domain)
...
**KEEP:**
- 9 P0 issues list
- RegulatoryAgency/PrivacyRegulation/PaymentSecurity violations
- Risk classification
- Affected components
...
Rows:
1. CRITICAL | CarryoverDollarsDomainService | 1 file | 15 scenarios | RegulatoryAgency compliance failure | $500k
