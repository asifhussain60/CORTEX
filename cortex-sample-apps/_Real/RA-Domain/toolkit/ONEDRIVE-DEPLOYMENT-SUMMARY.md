...
### Regulatory Views (2)
- ✅ `regulatory/p0-issues-tracker.html` - 9 P0 compliance issues (RegulatoryAgency/PrivacyRegulation/PaymentSecurity/BenefitsRegulation)
...
| **Bus Factor (Rollover)** | 1 | 3+ | CRITICAL knowledge silo |
...
2. View 4 core capabilities:
   ...
   - Request Processing (NServiceBus integration)
   - Plan Management (PercentPlanLedger)

### For Regulatory/Compliance:
1. Open: `regulatory/p0-issues-tracker.html`
2. View 9 P0 issues:
   - **RegulatoryAgency:** 4 issues ($350k risk) - Form 5500, Pub 969, Code §125
   - **PrivacyRegulation:** 3 issues ($120k risk) - PHI in logs, encryption
   - **PaymentSecurity:** 1 issue ($30k risk) - Unencrypted queue data
   - **BenefitsRegulation:** 1 issue ($20k risk) - Participant disclosure
...
- Manual refresh: Re-run `business_value_scanner.py` on C:\PROJECTS\Product.PaymentAccounts
