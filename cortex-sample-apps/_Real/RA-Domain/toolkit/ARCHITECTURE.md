...
```
cortex-brain/dashboards/data/repos/Product.PaymentAccounts/
...
def discover_and_register_ra_domain():
    ...
    """
    ra_domain_path = Path('C:/PROJECTS/Product.PaymentAccounts')
    output_path = Path('cortex-brain/dashboards/data/repos/Product.PaymentAccounts')
    
    # Check if analysis exists
    if (output_path / 'dashboard.json').exists():
        registry_entry = {
            'id': 'ra-domain-analysis',
            'name': 'Product.PaymentAccounts',
...
.\01_quick_scan.ps1 -RepoPath "C:\PROJECTS\Product.PaymentAccounts"

# Full analysis (all 20 batches)
python 06_master_orchestrator.py --repo-path "C:\PROJECTS\Product.PaymentAccounts" --execute-all

# Specific batch execution
python 06_master_orchestrator.py --repo-path "C:\PROJECTS\Product.PaymentAccounts" --batch 11
```
...
python -m src.orchestrators.dashboard_launcher --source "Product.PaymentAccounts"
...
orchestrator = RADomainOrchestrator(
    repo_path='C:/PROJECTS/Product.PaymentAccounts',
    output_dir='cortex-brain/dashboards/data/repos/Product.PaymentAccounts'
)
...
repository:
  path: "C:/PROJECTS/Product.PaymentAccounts"
  name: "Product.PaymentAccounts"
  type: "external_csharp"

output:
  base_dir: "cortex-brain/dashboards/data/repos/Product.PaymentAccounts"
  formats:
    - json
    - markdown
...
class TestCoverageIntelligenceCollector(RABaseCollector):
    ...
    def prioritize_test_gaps(self) -> List[Dict]:
        ...
        gaps.append({
            'priority': 'P0',
            'component': 'PaymentAccountBalanceService',
    ...
    def generate_catalog(self) -> Dict[str, Any]:
        return {
            'capabilities': [
                ...
                {
                    'name': 'Request Processing',
                    'services': ['PaymentAccountBalanceService'],
                    'background_jobs': [],
                    'test_coverage': '10%',
    ...
    def generate_documentation(self) -> Dict[str, Any]:
        return {
            ...
            'missing_xml_comments': [
                ...
                'PaymentAccountBalanceService (15 methods undocumented)'
            ],
            'quality_gates': {
...
# 2. Output: cortex-brain/dashboards/data/repos/Product.PaymentAccounts/onedrive-site/
...
2. Auto-update `cortex-brain/dashboards/data/repos/Product.PaymentAccounts/latest.json`
