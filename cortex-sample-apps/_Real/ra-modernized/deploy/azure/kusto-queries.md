# Application Insights Kusto Queries for RA Funding Invoices Monitoring

This document contains pre-built Kusto (KQL) queries for monitoring RA Funding Invoices migration.
