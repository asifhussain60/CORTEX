...
**Location:** `tests/RA.FundingInvoices.ContractTests/Tests/TestScenarioValidationTests.cs`
...
**Location:** `tests/RA.FundingInvoices.ContractTests/TestScenarios/test-scenarios.json`
...
- ✅ Task 5.2: GenerateFundingInvoiceAsync migration
...
- GenerateFundingInvoiceTests.cs: 9 unit tests
...
**Project:** RA Modernization - Phase 5 Legacy Service Migration
