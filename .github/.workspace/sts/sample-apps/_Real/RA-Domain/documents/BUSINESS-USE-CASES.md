...
2. **Feature Flag Filtering** `[CODE: ExampleFeatureFlagService.GetIsEmployerCarryoverFeatureFlagEnabledAsync()]`
...
4. **Account-Level Rollover Calculation** `[CODE: ExampleDomainService]`
...
2. **Data Retrieval** `[CODE: ExampleBalanceService]`
...
1. **Create Flex Span** `[CODE: ExampleFlexService.CreateOrUpdateFlexSpan()]`
...
2. **Customer Registration** `[CODE: ExampleMemberService]`
...
**Service:** `ExampleFeatureFlagService` `[CODE]`  
...
**Service:** `ExampleSettingsService` `[CODE]`  
...
**PaymentAccount** `[CODE: App.Example.Domain.Entities]`
...
**RolloverTransferTracking** `[CODE: App.Example.Domain.Entities]`
...
**BalanceChangeAudit** `[CODE: App.Example.Domain.Entities]`
...
**RolloverSettings** `[CODE: App.Example.Domain.Entities]`
...
- **Dependencies:** ExampleBalanceService, ExampleSettingsService, NServiceBus

**ExampleBalanceService** `[CODE]`
...
**ExampleFeatureFlagService** `[CODE]`
...
1. **Method Signature Analysis** `[CODE: rollover-service-methods.json]`
   - Extracted 20 methods from ExampleDomainService
...
3. **Service Dependency Graph** `[CODE: batch-5-*.json]`
   ...
   - Example: ExampleDomainService → ExampleBalanceService
