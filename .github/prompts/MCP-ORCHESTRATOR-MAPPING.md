...
CORTEX exposes **51 wired orchestrators** via **39 MCP tools**. This guide maps orchestrators to their MCP entry points for external repository integration and SaaS deployment.
