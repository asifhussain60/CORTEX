...
3. **"Wave" deprecated as execution concept**
   - Historical "WAVE-X" files → archived
...
|-------------|---------------|-----------|
| WAVE-1 | E-001: Production Foundation | Strategic scope (months) |
| WAVE-Q | F-010: Multi-Cycle TDD | Feature-level (weeks) |
| WAVE-R | F-011: Debug Tooling | Feature-level (weeks) |
| WAVE-7-CLEANUP | P-052: Interface Compliance | Phase-level (days) |
