...
Use this template for ANY autonomous phase/plan completion report. Replace bracketed variables with actual values.
...
📋 **[PHASE/PLAN NAME] [STAGE NUMBER]: [STAGE TITLE]**
...
📋 **PHASE-R Stage 4: Integration Testing**
...
📋 **MASTER-PLAN-V5 Phase A: Foundation Infrastructure**
...
1. **Autonomous Phase Completion** — After `/implement phase X` completes
