...
class CleanerRegistry:
    ...
    def get_cleaner(
        ...
        2. Per-cleaner config: cortex_intelligence/tier1/orchestrators/cleaners/<domain>/config.yaml
        3. Global config: cortex_intelligence/vacuum/config.yaml
    ...
    def _load_config(self, domain: str) -> Dict[str, Any]:
        ...
        Resolution order:
        1. Per-cleaner config: cortex_intelligence/tier1/orchestrators/cleaners/<domain>/config.yaml
        2. Global config: cortex_intelligence/vacuum/config.yaml
