...
This module builds author context to identify file experts.
...
class AuthorContribution:
    ...
    Attributes:
        ...
        lines_removed: Total lines removed (if available)
    """
    name: str
    commit_count: int = 0
    files_touched: int = 0
...
class AuthorContextBuilder:
    ...
    Example:
        ...
        >>> experts = builder.get_file_experts(Path("src/core/main.py"))
