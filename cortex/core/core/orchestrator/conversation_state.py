...
class ConversationStateManager:
    ...
    def __init__(self, db_path: Optional[Path] = None) -> None:
        ...
        Args:
            db_path: Path to SQLite database. Defaults to cortex/intelligence/state/conversations.db
        """
        if db_path is None:
            db_path = Path(__file__).parent.parent.parent.parent.parent / "cortex.intelligence" / "state" / "conversations.db"
