...
class EnvironmentConfig:
    ...
    is_development: bool
    cortex_root: Path
    tool_adapter_class: str  # Qualified class name (e.g., 'cortex.core.tool_adapter.MCPToolAdapter')
...
class EnvironmentDetector:
    ...
    def get_environment_config(self) -> EnvironmentConfig:
        ...
        if is_mcp:
            ...
            adapter_class = "cortex.core.tool_adapter.MCPToolAdapter"
        elif is_copilot:
            env_type = EnvironmentType.COPILOT
            adapter_class = "cortex.core.tool_adapter.CopilotToolAdapter"
        else:
            env_type = EnvironmentType.DEVELOPMENT
            adapter_class = "cortex.core.tool_adapter.DevelopmentToolAdapter"
