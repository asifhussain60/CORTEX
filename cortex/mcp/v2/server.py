...
from cortex.mcp.v2.base import Tool, ToolResult, ToolCategory
from cortex.mcp.v2.registry import ToolRegistry, get_registry
...
class MCPServerV2:
    """
    CORTEX MCP Server v2 - Consolidated Production Server.
    
    Features:
    - 24 production tools (down from 98)
