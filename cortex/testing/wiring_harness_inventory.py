...
class WiringHarnessInventory:
    ...
    CHALLENGE_INTEGRATION_CHALLENGE_GENERATOR = UnwiredComponent(
        ...
        implementation_location="cortex/orchestrators/core/intent_router/challenge_generator.py",
        entry_point="cortex.orchestrators.core.intent_router.challenge_generator.ChallengeGenerator",
    ...
    CHALLENGE_INTEGRATION_ORCHESTRATOR = UnwiredComponent(
        ...
        dependencies=[
            WiredComponentDependency("ChallengeGenerator", "cortex.orchestrators.core.intent_router.challenge_generator.ChallengeGenerator")
        ],
        orchestrator_hook_type="stage_3_knowledge_integration",
    ...
    TDD_ORCHESTRATOR_WIRED = {
        ...
        "dependencies": {
            "KnowledgeGuidanceEngine": "cortex.core.knowledge_guidance_engine.KnowledgeGuidanceEngine",
...
# REMOVED: Manual registry pattern - integration_notes="Critical for production resilience. Must wire fallback strategies for all critical components.",
    ...
    INTENT_CANONICALIZER = UnwiredComponent(
        ...
        implementation_location="cortex/orchestrators/core/intent_router/intent_canonicalizer.py",
    ...
    INTENT_REFLECTION_PROTOCOL = UnwiredComponent(
        ...
        implementation_location="cortex/orchestrators/core/intent_router/intent_reflection_protocol.py",
        entry_point="cortex.orchestrators.core.intent_router.intent_reflection_protocol.IntentReflectionProtocol",
    ...
    COMPREHENSION_YAML_GENERATOR = UnwiredComponent(
        ...
        implementation_location="cortex/orchestrators/core/intent_router/comprehension_yaml.py",
        entry_point="cortex.orchestrators.core.intent_router.comprehension_yaml.ComprehensionYAMLGenerator",
    ...
    UNIFIED_KNOWLEDGE_SERVICE = UnwiredComponent(
        ...
        entry_point="cortex.core.knowledge.unified_service.UnifiedKnowledgeService",
    ...
    INTELLIGENT_KNOWLEDGE_ROUTER = UnwiredComponent(
        ...
        entry_point="cortex.core.knowledge.router.IntelligentKnowledgeRouter",
