...
class DashboardOrchestrator(ABC):
    ...
    - Manage dashboard files in cortex-registry/company/dashboards/data/
    ...
    def __init__(self):
        ...
        self.dashboard_base_path = Path("cortex-registry/cortex-registry/company/dashboards/data")
