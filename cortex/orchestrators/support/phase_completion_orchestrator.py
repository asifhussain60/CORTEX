    ...
    def _update_phase_yaml(self, phase_file: Path, phase_key: str) -> bool:
        ...
        try:
            ...
            if "metadata" not in phase_data:
                self.logger.error("Invalid phase YAML: missing 'metadata' key")
                return False
            ...
            if "completion_status" not in metadata:
                self.logger.error("Invalid phase YAML: missing 'completion_status'")
                return False
    ...
    def _update_enhancement_history(self, enhancement_id: str, phase_key: str) -> bool:
        ...
        try:
            ...
            if result:
                ...
                self.logger.warning("Enhancement history update returned False")
                return False
