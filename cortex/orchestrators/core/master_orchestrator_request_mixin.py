    ...
    def execute_operation(
        ...
        try:
            ...
            dependencies = {
                ...
                "intent_gateway": getattr(self, "intent_gateway", None),
                ...
                "tddorchestrator": getattr(self, "tdd_orchestrator", None),
                "planningorchestrator": getattr(self, "plan_orchestrator", None),
