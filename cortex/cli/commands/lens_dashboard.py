...
def serve(repo_name: Optional[str], port: int, no_browser: bool, host: str) -> None:
    ...
    if repo_name and repo_name.lower() == 'cortex':
        ...
        click.echo("🧠 Starting CORTEX LENS Dashboard for CORTEX repository...")
    else:
        url = base_url
        click.echo("🧠 Starting LENS Dashboard server...")
...
def generate(repo: str, output: str) -> None:
    ...
    try:
        ...
        if dashboard_template.exists():
            ...
            click.echo("⚠️  Template not found, JSON only saved")
