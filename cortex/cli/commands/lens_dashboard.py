...
@click.option('--output', '-o', default='./lens-dashboards', type=click.Path(), help='Output directory')
...
@click.option('--directory', '-d', default='./lens-dashboards', type=click.Path(exists=True), 
