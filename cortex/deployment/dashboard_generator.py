...
"""
    ...
    def generate_trend_charts(self, trends: Dict[str, Any]) -> str:
        ...
        html += f"<canvas id='trendChart' width='400' height='200'></canvas>"
        html += "</div>"
        return html
    ...
    def generate_rollback_timeline(self, rollback_events: List[Dict[str, Any]]) -> str:
        ...
        for event in rollback_events:
            ...
            html += f"<div style='background: #fff; margin: 10px 0; padding: 15px; border-left: 4px solid #e74c3c; border-radius: 4px;'>"
