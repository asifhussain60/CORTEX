    ...
    def generate_report(self) -> str:
        ...
        if priorities:
            for i, (target, violation_count) in enumerate(priorities, 1):
                ...
                report.append("   Pattern: Use CONS-style composition pattern")
                report.append("   Action: Consolidate to UnifiedXXX class")
...
def main():
    ...
    # Save report to reports/ directory (CORE-002 compliant)
    report_path = Path("reports/audit") / \
