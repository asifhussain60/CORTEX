...
- cortex/intelligence/tier3/knowledge/ (technical knowledge)
...
class KnowledgeMerger:
    ...
    def __init__(self, workspace_root: Path) -> None:
        ...
        self.technical_knowledge_path = workspace_root / "cortex.intelligence" / "tier3" / "knowledge"
    ...
    def _get_target_file(
        ...
        if pattern_type == "TECHNICAL":
            ...
            base_path = self.workspace_root / "cortex.intelligence" / "state" / "user_preferences"
            base_path.mkdir(parents=True, exist_ok=True)
