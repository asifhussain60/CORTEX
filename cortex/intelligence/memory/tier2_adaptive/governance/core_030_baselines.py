...
class MetricType(str, Enum):  # CORE-035-scoped — domain-specific metric classification
...
class PerformanceMonitor:
    ...
    def __init__(self, slas: Optional[Dict[str, Dict[str, PerformanceSLA]]] = None) -> None:
        ...
        if slas is None:
            from cortex.intelligence.memory.tier2_adaptive.governance.core_030_baselines import CORE_030_BASELINES
