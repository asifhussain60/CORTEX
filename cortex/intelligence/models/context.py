"""
Canonical intelligence context models — Phase 107 Sub-Phase A.

Single source of truth for:
  - SynthesisResult         (canonical — replaces tier3/knowledge/synthesis_engine.SynthesisResult)
  - UnifiedIntelligenceContext
  - Supporting dataclasses: LENSIntelligence, CompanyKnowledge, CORTEXKnowledge

Authority: GAP-107-02 (CORE-035 — single canonical implementation)
SSOT:      cortex/intelligence/models/context.py
Compat:    cortex/intelligence/knowledge/unified_intelligence_context.py re-exports from here
"""
...
class SynthesisResult:
    ...
    Note: The tier3/knowledge/synthesis_engine.SynthesisResult (with 'query' field)
    is a separate, incompatible type used only within SynthesisEngine. This canonical
    class is for unified intelligence context flow through orchestrators.
    """
...
class UnifiedIntelligenceContext:
    ...
    def create_empty(
        ...
        Args:
            intent_type: Intent type string (e.g. "IMPLEMENT").
            file_path: Optional file path being analyzed.

        Returns:
            Empty UnifiedIntelligenceContext with all empty collections.
        """
        return cls(
            lens_intelligence=LENSIntelligence(
                git_analysis={},
