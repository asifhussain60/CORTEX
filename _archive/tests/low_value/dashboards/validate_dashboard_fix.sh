...
echo "----------------------------"
test_file "cortex-registry/company/dashboards/spa/js/app.js" "Main dashboard file exists"
...
echo "----------------------------"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "class LazyTabRenderer" "LazyTabRenderer class defined"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "queueRender" "queueRender() method exists"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "flushQueue" "flushQueue() method exists"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "getPendingCount" "getPendingCount() method exists"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "this.lazyTabRenderer = new LazyTabRenderer()" "LazyTabRenderer instantiated"
echo ""

echo "🎯 Container Coverage Validation"
echo "--------------------------------"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "renderVulnerabilities" "renderVulnerabilities() method exists"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "renderVulnerabilityTypes" "renderVulnerabilityTypes() method exists"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "renderCodeSmells" "renderCodeSmells() method exists"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "renderLicenseSummary" "renderLicenseSummary() method exists"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "renderKeyFindings" "renderKeyFindings() method exists"
echo ""

echo "🔗 Integration Validation"
echo "-------------------------"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "queueRender('vulnerabilities-list'" "Vulnerabilities uses queueRender"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "queueRender('vuln-types-list'" "Vuln types uses queueRender"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "queueRender('code-smells-grid'" "Code smells uses queueRender"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "queueRender('license-summary'" "License summary uses queueRender"
test_contains "cortex-registry/company/dashboards/spa/js/app.js" "lazyTabRenderer.flushQueue" "Queue flushing integrated"
echo ""
