...
from cortex.brain.llm.anthropic_provider import ANTHROPIC_AVAILABLE, AnthropicProvider
from cortex.brain.llm.i_llm_provider import ILLMProvider
from cortex.brain.llm.openai_provider import OPENAI_AVAILABLE, OpenAIProvider
...
class LLMFactory:
    ...
    def register_provider(
        ...
        if not issubclass(provider_class, ILLMProvider):
            raise ValueError(
                "Provider class must implement ILLMProvider interface"
            )
