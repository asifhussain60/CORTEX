...
**File:** `02-business-leaders-steering.md` | **Source:** `sources/02-business-leaders-source.md` | **Format:** Cinematic | **Narrator:** Male
...
- [ ] Create new notebook
- [ ] Upload `sources/02-business-leaders-source.md` as the **only** source
