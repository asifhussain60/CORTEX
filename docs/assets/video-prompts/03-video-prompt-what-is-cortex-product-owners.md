# Video Prompt 03 — CORTEX for Product Owners

---
**Series:** CORTEX — The Governed AI Engineering Partner
**Video:** 03 of 07 (Role Series)
**Title:** CORTEX for Product Owners
**Subtitle:** From Backlog to Verified Delivery
**Audience:** Product Owners, Scrum Masters, Delivery Managers — people who own requirements, sprint outcomes, and stakeholder trust
**Duration:** 7–10 minutes
**Narrator:** 🎙️ Female — energetic, precise, outcome-focused; connects technical capability to delivery value
**Generator:** Google Gemini Video Generator / NotebookLM Video Editor
**Domain Color:** Emerald `#10b981` (delivery, traceability, growth)
...
**Visual:** `#0a0e27` navy. Emerald particles. Logo with emerald glow. Title: "CORTEX for Product Owners" → subtitle: "From Backlog to Verified Delivery." Logo shrinks to watermark.
...
| VBP-002 Hook in 8s | ✅ Failed demo, broken traceability |
| VBP-003 Narration ≠ slide | ✅ AC cards complement narration |
| VBP-006 Contrast | ✅ Broken threads → solid connections |
| VBP-007 2-min cycles | ✅ New scene every 90–120s |
| VBP-009 Signaling | ✅ Emerald highlight on active AC |
| VBP-011 Strategic Silence | ✅ After delivery metrics |
| VBP-012 Consistent visuals | ✅ Emerald domain accent |
| VBP-014 Hero intro | ✅ 5s |
| VBP-015 Breadcrumb | ✅ 3-stage progress bar |
| VBP-016 Bold keywords | ✅ Emerald on traceability terms |
| VBP-017 Female narrator | ✅ Odd-numbered |
| VBP-018 Acronyms expanded | ✅ LENS, AC, TDD, DoR on first use |
| VBP-019 Colour intelligence | ✅ Emerald for delivery/growth |
