...
Response: Governance rules render -- 60+ rules listed.
Narrator: "Loading rules confirms the governance registry is healthy. If a YAML file in cortex-registry/core/ has a syntax error, this call will show fewer rules. Sixty-plus is the expected count."
