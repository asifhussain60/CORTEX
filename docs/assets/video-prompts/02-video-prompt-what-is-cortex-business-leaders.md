# Video Prompt 02 — CORTEX for Business Leaders

---
**Series:** CORTEX — The Governed AI Engineering Partner
**Video:** 02 of 07 (Role Series)
**Title:** CORTEX for Business Leaders
**Subtitle:** ROI. Compliance. Predictable Delivery.
**Audience:** CTOs, VPs of Engineering, Heads of Delivery — leaders who own budgets, risk, and shipping cadence
**Duration:** 7–10 minutes
**Narrator:** 🎙️ Male — warm, confident, boardroom-appropriate; data-driven gravitas
**Generator:** Google Gemini Video Generator / NotebookLM Video Editor
**Domain Color:** Purple `#7b61ff` (authority, strategic depth)
...
Business leaders understand how CORTEX translates engineering discipline into measurable business outcomes: reduced rework cost, automated compliance evidence, predictable sprint delivery, and ROI on AI investments.
...
**Visual:** `#0a0e27` navy. Purple particles. Logo with purple glow. Title: "CORTEX for Business Leaders" → subtitle: "ROI. Compliance. Predictable Delivery." Logo shrinks to watermark.
...
| VBP-002 Hook in 8s | ✅ Red KPIs, rework cost |
| VBP-003 Narration ≠ slide | ✅ Dashboard reinforces narrative |
| VBP-006 Contrast | ✅ Red KPIs → green metrics |
| VBP-007 2-min cycles | ✅ Scene transitions every 90–120s |
| VBP-011 Strategic Silence | ✅ After ROI counter |
| VBP-012 Consistent visuals | ✅ Purple domain accent |
| VBP-013 Business book anchoring | ✅ Drucker, Covey, Collins |
| VBP-014 Hero intro | ✅ 5s |
| VBP-015 Breadcrumb | ✅ 3-stage progress bar |
| VBP-016 Bold keywords | ✅ Purple/cyan on key metrics |
| VBP-017 Male narrator | ✅ Even-numbered |
| VBP-018 Acronyms expanded | ✅ |
| VBP-019 Colour intelligence | ✅ Purple authority, red→green contrast |
