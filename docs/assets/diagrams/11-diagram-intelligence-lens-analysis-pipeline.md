...
# Knowledge Guidance Traceability — Auditable Decision Trail

*Phase 143 COMPLETE*

```
 ═══════════════════════════════════════════════════════════════════════════════
  Every knowledge consultation emits a decision trace
  "Full audit compliance for QW-006"
 ═══════════════════════════════════════════════════════════════════════════════

  ┌──────────────────────────────────────────────────────────────────────┐
  │  KnowledgeGuidanceEngine.resolve()                                   │
  │  cortex/core/knowledge_guidance_engine.py                           │
  └──────────────────────────────┬───────────────────────────────────────┘
                                 │
                  (after guidance resolution, before caching)
                                 │
                                 ▼
  ┌──────────────────────────────────────────────────────────────────────┐
  │  DecisionTraceabilityLogger.log_decision()                          │
  │  cortex/intelligence/explainability/decision_logger.py              │
  │                                                                      │
  │  Fields recorded:                                                    │
  ...
  │    rationale = "Resolved {n} guidance entries for {domain}/{module}"│
  ...
  │                                                                      │
  │  Query capability via cortex_learning op=history                     │
  └──────────────────────────────────────────────────────────────────────┘
```

**Business impact:** Every knowledge consultation is now auditable — providing evidence of which guidance was consulted, for which module, with what confidence, and why. Required for QW-006 compliance.

---

# Documentation Intelligence — 60+ Best Practices

*Phase 145 COMPLETE*

```
 ═══════════════════════════════════════════════════════════════════════════════
  10 sub-domains × 6+ practices each = 60+ best practices
  "Documentation quality is now a governed domain"
 ═══════════════════════════════════════════════════════════════════════════════

  ┌──────────────────────────────────────────────────────────────────────┐
  │  cortex-registry/knowledge/best-practices/documentation/            │
  │  documentation-intelligence.yaml                                     │
  │                                                                      │
  │  10 Sub-Domains:                                                     │
  │  ┌─────────────────────────────────────────────────────────────┐    │
  ...
  Domain Signal Triggers:
  document|documentation|docs|writing|readme|runbook|adr|release.notes

  Registration:
  cortex-registry/knowledge/INDEX.yaml (domain: documentation)
  cortex-registry/config/domain-signal-map.yaml (pattern added)
```

**Business impact:** Documentation-related requests now receive domain-specific guidance — API docs get API documentation best practices, runbooks get operational documentation patterns, ADRs get decision recording standards.
