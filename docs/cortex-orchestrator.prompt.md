...
**Authority:** The single source of truth is `_workspaces/roadmap/cortex-master.yaml` → `phase_tracker` section.
...
├── _workspaces/roadmap/cortex-master.yaml (SSOT)
...
3. CLEAN UP DOCUMENTATION
   ...
   ├─ Move any reports to _workspaces/roadmap/reports/
...
DECISION: Is PHASE-X ready to lock?
  ...
  START
    ...
    │  YES → Continue
    │
    ├─ Are all documentation reports in _workspaces/roadmap/reports/?
