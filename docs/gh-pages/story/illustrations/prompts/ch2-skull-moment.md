# Chapter 2: The SKULL Rules Moment - The Awakening of CORTEX

**Image Type:** Comic Story Illustration (NOT Technical Diagram)  
**Purpose:** Chapter 2 iconic moment - finger frozen over Enter key before disaster  
**Style:** Black and white cartoon, freeze-frame dramatic moment  
**Context:** Birth of SKULL protection rules, Miss G intervention
...
- Dramatic radiating lines emanating from Enter key
- Sweat drop on finger (hesitation)
- Time: 2:17 AM visible on computer clock
- Code on screen showing destructive command (git reset --hard HEAD^)
...
PANEL 3 (BOTTOM, RESOLUTION):
- Wide shot showing whiteboard in background
- Whiteboard now has "SKULL RULES" written in large letters
...
**Story Integration:**
- Chapter 2 opener (most iconic story moment)
- Introduces SKULL rules through drama
- Shows Miss G's protective role
- "Rule #1" becomes recurring theme

**Educational Value:**
- Safety-first architecture made memorable
- "Creator is biggest threat" = universal truth
- Dramatic moment makes lesson stick

**Technical Connection:**
- Links to DALL-E narrative: 02-skull-protection.md (22 rules, 8 layers)
- Story humanizes why protection matters

**Callback Potential:**
- Referenced in later chapters when SKULL rules prevent disasters
- "Remember the Enter key moment" becomes shorthand

---

## File Output

**Filename:** `ch2-skull-moment.png`  
**Dimensions:** 800x1200px (vertical three-panel comic strip)  
**Optimization:** Convert to WebP (<120KB)  
**Alt Text:** "Three panels: finger hovering over Enter key, Miss G's ghostly STOP gesture, whiteboard showing SKULL RULES birth"
