...
### Quick Start
If you see garbled text like `—` instead of `—`:
...
mkdocs build --clean
python -c "from pathlib import Path; print('—' in Path('site/diagrams/story/The-CORTEX-Story/index.html').read_text(encoding='utf-8'))"
