# Diagram 06: The Basement (Origin Story) [OPTIONAL]
...
**Color Palette:**
- **Cool tones:** #3B82F6 (monitor blue), #10B981 (green accents)
- **Warm tones:** #F59E0B (amber lamp), #FEF3C7 (paper/notes)
- **Accent:** #6B46C1 (purple whiteboard glow)
