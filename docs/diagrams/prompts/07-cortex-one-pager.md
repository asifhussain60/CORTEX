# Diagram 07: CORTEX One-Pager (Comprehensive Overview)
...
- Main Title: "CORTEX" 
  * Font: Bold, 72pt, gradient fill (#3B82F6 to #6B46C1)
...
- Version Badge:
  ...
  * Style: Rounded pill (120px × 40px), white border, #10B981 fill
...
**Column Header:**
- Text: "🧠 Brain Architecture" (Bold, 32pt, #3B82F6)
...
- Position: y: 1800px
- Box: 1100×280px, rounded (16px), gradient background (#F59E0B 20% tint)
- Border: 4px solid #F59E0B
- Icon: 📊 Bar chart (60×60px, #F59E0B)
...
- Position: y: 1450px
- Box: 1100×280px, rounded (16px), gradient background (#10B981 20% tint)
- Border: 4px solid #10B981
- Icon: 🧩 Puzzle pieces (60×60px, #10B981)
...
- Position: y: 1100px
- Box: 1100×280px, rounded (16px), gradient background (#3B82F6 20% tint)
- Border: 4px solid #3B82F6
- Icon: 🗃️ Database (60×60px, #3B82F6)
...
- Position: y: 750px
- Box: 1100×280px, rounded (16px), gradient background (#6B46C1 20% tint)
- Border: 4px solid #6B46C1
- Icon: 🛡️ Shield (60×60px, #6B46C1)
...
**Column Header:**
- Text: "⚡ Features & Value" (Bold, 32pt, #F59E0B)
- Position: Top of column (y: 400px)
...
- Font: Regular, 12pt, white on #6B46C1 background
