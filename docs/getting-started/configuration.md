...
theme:
  name: material
  features: ["navigation.instant", "navigation.tracking", "navigation.tabs", "navigation.sections", "navigation.expand", "navigation.top", "search.suggest", "search.highlight", "content.code.copy", "toc.integrate"]
```
...
**Location**: `cortex-brain/admin/documentation/config/source-mapping.yaml`
...
**Location**: `cortex-brain/admin/documentation/config/validation-rules.yaml`
...
**Location**: `cortex-brain/admin/documentation/config/diagram-definitions.yaml`
