...
**Storage:** `cortex_brain/governance.db` (SQLite database) with indexed queries for fast retrieval
...
**Storage Location:** `cortex_brain/` directory with subdirectories: `tier0/`, `tier1/`, `tier2/`, `tier3/`, `governance/`, `domain/`, `state/`
