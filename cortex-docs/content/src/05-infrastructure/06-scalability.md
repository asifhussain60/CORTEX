...
**Product Owner:** "Scaling is horizontal — add more Kubernetes pods for more capacity. Test parallelism uses all CPU cores by default. 15,328 tests run in minutes, not hours."
