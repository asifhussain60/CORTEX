...
**Location:** `cortex/04-mcp/server.py` + `cortex/04-mcp/learning_gateway_interceptor.py`
...
**Location:** `cortex/08-learning/intelligence_validator.py`
...
**Dashboard:** `cortex/08-learning/learning_dashboard.py`
...
- **Learning System Overview:** `../08-learning/overview.md`
- **Orchestration Architecture:** `../03-orchestration/overview.md`
