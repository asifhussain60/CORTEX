...
- One canonical Python package (`cortex`), 22 wired orchestrators across 3 tiers, 25 MCP tools, 22 enforced governance rules.
...
| **Orchestrators** | 22 wired (6 core, 6 domain, 10 support) | ✅ IOrchestrator protocol enforced |
