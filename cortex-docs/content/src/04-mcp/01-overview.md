...
source_of_truth: cortex/04-mcp/ + deployment/mcp-gateway-config.yaml
format: diátaxis-explanation
voice: third-person-blended
related_diagrams: [c4-container.md, 06-request-lifecycle.md]
...
│                                                                    │
│  2. User types: "analyze cortex/04-mcp/server.py"                    │
...
│     └─→ cortex_lens_analyze(file_path="cortex/04-mcp/server.py")    │
│                                                                    │
...
```python
# Configure in cortex/04-mcp/config.py
RATE_LIMIT = {
...
**Orchestration:**
- [Orchestration Overview](../03-orchestration/overview.md) — The 21 orchestrators (14 active + 4 super + 7 deprecated)
- [Master Orchestrator](../03-orchestration/master-orchestrator.md) — Primary entry point
- [End-to-End Flow](../03-orchestration/end-to-end-flow.md) — Complete request lifecycle
...
- [Governance Compliance](../01-capabilities/governance-compliance.md) — Enforcement layer
**CORTEX MCP Version:** 2.0.0
