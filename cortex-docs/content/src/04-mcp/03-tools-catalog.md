...
---
title: CORTEX MCP Tools Catalog - Complete Tool Reference
type: reference
...
async def implement_feature():
    ...
    result = await client.call_tool("cortex_process_request", {
        ...
        "context": {
            "target_file": "cortex/04-mcp/server.py",
...
**Orchestration:**
- [Master Orchestrator](../03-orchestration/master-orchestrator.md) — `cortex_process_request` handler
- [TDD Orchestrator](../03-orchestration/tdd-orchestrator.md) — TDD workflow tools
- [Intent Router](../03-orchestration/intent-router.md) — Request classification

**Governance:**
- [Governance Compliance](../01-capabilities/governance-compliance.md) — Enforcement tools
