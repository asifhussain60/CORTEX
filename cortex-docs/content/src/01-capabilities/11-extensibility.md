...
|---------|----------|--------|----------|
| **CSharpAdapter** | C# | tree-sitter-c-sharp | `cortex/02-lens/adapters/csharp_adapter.py` |
| **JavaAdapter** | Java | tree-sitter-java | `cortex/02-lens/adapters/java_adapter.py` |
| **JavaScriptAdapter** | JavaScript | tree-sitter-javascript | `cortex/02-lens/adapters/javascript_adapter.py` |
| **TypeScriptAdapter** | TypeScript | tree-sitter-typescript | `cortex/02-lens/adapters/typescript_adapter.py` |
...
- [Tool Registry](../06-toolkit/tool-registry.md) — Tool management and discovery
- [Developer Guide](../06-toolkit/developer-guide.md) — Building custom tools
- [Orchestration Overview](../03-orchestration/01-overview.md) — Orchestrator architecture
- [Wiring Contracts](../05-infrastructure/tech-stack.md) — Configuration management
