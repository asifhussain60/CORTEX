...
- [Interaction Protocol](../03-orchestration/end-to-end-flow.md) — Request/response lifecycle
- [MasterOrchestrator](../03-orchestration/master-orchestrator.md) — Response coordination
- [CORTEX Brain Architecture](../00-getting-started/04-brain-tier-architecture.md) — Cognitive processing
