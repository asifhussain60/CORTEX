...
```python
# cortex/04-mcp/tools/my_custom_tool.py
...
```python
# cortex/04-mcp/tools/my_custom_tool.py (continued)
...
```python
# cortex/04-mcp/tools/__init__.py
...
```python
# cortex/04-mcp/server.py

@app.route("/04-mcp/tools/list", methods=["GET"])
...
@app.route("/04-mcp/tools/call", methods=["POST"])
async def call_tool():
    """Call a tool by name."""
...
```python
# tests/04-mcp/tools/test_my_custom_tool.py
