...
source_of_truth: cortex/04-mcp/tools/ + cortex-registry/master/
format: diátaxis-reference
voice: third-person-blended
related_diagrams: [06-request-lifecycle.md, tool-integration-patterns.md]
total_tools: 10
...
- [MCP Integration](../04-mcp/tools-catalog.md) — MCP exposure
