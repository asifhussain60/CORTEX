...
### 1. Universal Learning Loop (`cortex/08-learning/universal_learning_loop.py`)
...
### 3. MCP Gateway Learning Interceptor (`cortex/04-mcp/learning_gateway_interceptor.py`)
...
### 5. Orchestrator Learning Mixin (`cortex/08-learning/orchestrator_integration_mixin.py`)
...
### 6. Intelligence Validator (`cortex/08-learning/intelligence_validator.py`)
...
### 7. Learning Dashboard (`cortex/08-learning/learning_dashboard.py`)
...
### 8. Module Integration (`cortex/08-learning/__init__.py`)
...
- **Orchestration System:** `../03-orchestration/overview.md`
- **LENS Intelligence:** `../02-lens/overview.md`
- **Governance & Compliance:** `../01-capabilities/governance-compliance.md`
