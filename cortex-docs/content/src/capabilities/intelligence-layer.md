...
source_of_truth: cortex/orchestrators/health/intelligence.py + cortex/toolkit/cleanup/vacuum_intelligence.py
...
- [Vacuum Operations Guide](../toolkit/cleanup.md)
- [LENS Intelligence Architecture](../lens/architecture.md)
