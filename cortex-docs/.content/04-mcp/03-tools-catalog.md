...
*Verified against `cortex/mcp/tools/` live code · 23 February 2026 · 26 active tools (28 total — 2 deprecated)*
...
In addition to the 26 active tools above, several supporting modules provide focused capabilities:
...
**Business Leader:** "26 active tools, one entry point (`cortex_process_request`). Developers can't bypass governance — the architecture enforces it."
...
*Verified against `cortex/mcp/tools/` — 30 Python tool files, 26 active canonical tools (28 total — 2 deprecated) · 23 February 2026*
