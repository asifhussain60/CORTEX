...
[Stage 2: Unit Tests (Parallel)]
       ...
       │ Full test suite across all tiers
       │
       ▼
...
**Business Leader:** "Every code change goes through automated validation stages before it can merge. Golden tests guarantee no regression. Governance rules are enforced by machines, not people."
...
*Verified against `cortex/infrastructure/ci_cd/` and CI pipeline configuration*
