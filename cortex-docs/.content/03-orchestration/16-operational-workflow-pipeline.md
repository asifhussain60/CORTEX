...
The `_check_for_workflow_template()` method in MasterOrchestrator was expanded from 6 to 20 operation types, ensuring all intent types that have associated workflow templates are correctly bound.

---

## Workflow Template Categories (79 Templates)

The complete template library lives at `cortex-registry/workflows/templates/` across 17 categories:

| Category | Templates | Purpose |
|----------|-----------|---------|
| audit | 1 | Audit-fix pipeline |
| backend | 2 | C# refactor + security |
...
| sdlc | 7 | Requirements → release lifecycle |
