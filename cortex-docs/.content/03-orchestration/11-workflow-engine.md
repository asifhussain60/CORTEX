...
Before Phase 67, CORTEX had rich YAML workflow templates but no runtime that could:
...
Phase 67-D added `convergence_gate` blocks to the canonical TDD and audit YAML templates:
...
**Why this matters:** Before Phase 67, audit-fix was a single pass. You could run `/audit fix` and still have residual violations because fixes introduced new ones. The convergence loop eliminates this — it keeps going until the system is clean.
...
| Phase 67 detail | `cortex-registry/planning/phases/completed/phase-67.yaml` |
...
*Phase 67 COMPLETE — all 6 GAPs closed (GAP-67-A through GAP-67-F) · Verified 2026-02-25*
