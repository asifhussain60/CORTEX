# Prompt 01 — Three-Tier Intelligence Architecture# Prompt 01 — Three-Tier Brain Architecture



## Target Tool: Google Gemini Image Editor / NotebookLM## Target Tool: Google Gemini Image Editor / NotebookLM
...
> ⚠️ **Before generating:** Read `README.md` in this folder for the MANDATORY color palette, glassmorphism style, text contrast rules, typography, and CORTEX logo watermark rules.> ⚠️ **Before generating:** Read `README.md` in this folder for the MANDATORY color palette, glassmorphism style, typography, and CORTEX logo watermark rules. All images must match the dark-blue glassmorphism theme of the CORTEX documentation site.
...
Create a highly detailed, cinematic technical illustration of a three-tier cognitive architecture represented as a translucent human brain cross-section.Create a highly detailed, cinematic technical illustration of a three-tier cognitive architecture represented as a translucent human brain cross-section.



VISUAL IDENTITY — MANDATORY:VISUAL IDENTITY — MANDATORY:

- Background: Deep space navy (#0a0e27) with subtle grid pattern (rgba(255,255,255,0.03) lines)- Background: Deep space navy (#0a0e27) with subtle grid pattern (rgba(255,255,255,0.03) lines)

- All info panels: Glassmorphic — rgba(26, 31, 58, 0.7) fill, 1px rgba(255,255,255,0.1) border, 12-16px corner radius, 10-20px backdrop blur- All info panels: Glassmorphic — rgba(26, 31, 58, 0.7) fill, 1px rgba(255,255,255,0.1) border, 12-16px corner radius, 10-20px backdrop blur

- Primary accent glow: Cyan (#00d4ff) with 0 0 20px rgba(0, 212, 255, 0.3) glow- Primary accent glow: Cyan (#00d4ff) with 0 0 20px rgba(0, 212, 255, 0.3) glow

- Secondary accent: Purple (#7b61ff) for decorative highlights- Secondary accent: Purple (#7b61ff) for decorative highlights

- Shadows on all floating elements: 0 8px 32px rgba(0, 0, 0, 0.37)- Shadows on all floating elements: 0 8px 32px rgba(0, 0, 0, 0.37)

- TEXT CONTRAST: All text on dark backgrounds in #ffffff or #00d4ff. Labels on glowing areas must have a dark pill background rgba(10, 14, 39, 0.8). Headings bold with text-shadow 0 2px 4px rgba(0,0,0,0.5)- Heading font: Space Grotesk (bold, geometric sans-serif)

- Heading font: Space Grotesk (bold, geometric sans-serif)- Label font: JetBrains Mono (monospace)

- Label font: JetBrains Mono (monospace, cyan #00d4ff)- Body font: Inter (clean sans-serif)

- Body font: Inter (clean sans-serif)- CORTEX logo watermark: Embossed at 20-30% opacity in the bottom-right corner, ~80px wide, with subtle inner shadow matching the glass aesthetic

- CORTEX logo watermark: Embossed at 20-30% opacity in the bottom-right corner, ~80px wide, with subtle inner shadow
