...
- FOUR horizontal tiers stacked vertically with glassmorphism panels:
  ...
  3. MIDDLE-BOTTOM — "Orchestration Layer" (emerald border): 282 Orchestrators across 9 domains, TDD, Debug, Health — execution
  4. BOTTOM — "Governance Layer" (amber border): 38 CORE Rules, Enforcement, Audit Logs, SQLite Persistence — compliance
