# CORTEX Image Prompt: Feature Delivery Pipeline
# Role: Product Owner
# Output: cortex-docs/assets/images/generated/product-owner/02-feature-delivery-pipeline.png
# Size: 1200x675 (16:9 landscape)
# Style: Dark glassmorphism, professional, flow-oriented
...
- A horizontal flow from left to right with 6 stages represented as connected glassmorphism hexagonal nodes:
  ...
  2. "LENS Analysis" (cyan #00d4ff glow) — AI analyzing requirements
  3. "TDD Scaffold" (purple #7b61ff glow) — tests auto-generated
  4. "Implementation" (emerald #10b981 glow) — code generated
