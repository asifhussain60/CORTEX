...
- **Face:** Original design — NOT modelled on any existing fictional character. Wide dark almond-shaped eyes with expressive arched brows. A proud angular nose. Full lips in a knowing smirk or calm smile. South Asian / Mediterranean beauty — striking, distinct, unmistakably hers. Expression shifts per scene: knowing, skeptical, proud, alarmed, tender.
- **Hair:** Long, thick black hair swept into a high ponytail with a purple ribbon/band. Loose strands frame her face elegantly.
- **Costume:** Elegant flowing luminous robes — semi-translucent like frosted starlight, draped in layered folds that catch and shimmer with the wave's accent-color glow, a simple sash at the waist, bare feet. The outfit reads timeless and ethereal — neither modern casual nor culturally coded.
