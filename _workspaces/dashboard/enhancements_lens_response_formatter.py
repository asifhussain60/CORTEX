...
class LENSResponseFormatter:
    ...
    def _format_markdown(
        ...
        if challenges:
            ...
            lines.append("Γ£ô No challenges identified")
            lines.append("")
        ...
        lines.append("- **Γ£à Approve** - Proceed with execution")
        lines.append("- **Γ¥î Reject** - Cancel and refine request")
        lines.append("- **Γ¥ô Clarify** - Ask for more information")
        lines.append("")
    ...
    def _get_severity_emoji(self, severity: str) -> str:
        ...
        return emoji_map.get(severity, "ΓÜ¬")
