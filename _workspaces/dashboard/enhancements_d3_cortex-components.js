            ...
            <div class="narrative-panel">
                <div class="narrative-header">
                    ...
                    <button class="narrative-toggle" onclick="this.closest('.narrative-panel').classList.toggle('collapsed')">
                        <span class="toggle-icon">Γû╝</span>
                    </button>
                </div>
            ...
            <div class="insights-list">
                ${insights.map(insight => `
                    <div class="insight-item">
                        <span class="insight-icon">${insight.icon || '≡ƒÆí'}</span>
...
class KPIScorecard {
    ...
    getTrendClass(trend) {
        if (!trend) return '';
        return trend.startsWith('+') || trend.startsWith('Γåæ') ? 'trend-up' : 'trend-down';
    }

    getTrendIcon(trend) {
        if (!trend) return '';
        return trend.startsWith('+') || trend.startsWith('Γåæ') ? 'Γåæ' : 'Γåô';
    }
}
            ...
            <div id="${this.id}" class="cortex-modal" style="display: none;">
                ...
                <div class="modal-container">
                    <div class="modal-header">
                        ...
                        <button class="modal-close" onclick="document.getElementById('${this.id}').style.display='none'">├ù</button>
                    </div>
