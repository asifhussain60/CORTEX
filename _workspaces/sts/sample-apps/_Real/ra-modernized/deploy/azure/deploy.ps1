# PowerShell deployment script for RA Funding Invoices Azure infrastructure
...
param(
    ...
    [Parameter(Mandatory=$false)]
    [string]$ResourceGroupName = "rg-ra-funding-invoices-$Environment",
...
Write-Host "║  RA Funding Invoices - Azure Infrastructure Deployment         ║" -ForegroundColor Magenta
Write-Host "╚════════════════════════════════════════════════════════════════╝" -ForegroundColor Magenta
Write-Host ""

# Deployment parameters
$deploymentName = "ra-funding-invoices-$(Get-Date -Format 'yyyyMMdd-HHmmss')"
