// Bicep template for RA Funding Invoices Azure infrastructure
...
param appName string = 'ra-funding-invoices'

@description('Tags for all resources')
param tags object = {
  Application: 'RA Funding Invoices'
  Environment: environment
  ManagedBy: 'Bicep'
  CostCenter: 'Engineering'
  Project: 'RA Modernization'
}
...
resource applicationInsights 'Microsoft.Insights/components@2020-02-02' = {
  ...
  properties: {
    ...
    DisableIpMasking: false // Mask IP addresses (HIPAA compliance)
