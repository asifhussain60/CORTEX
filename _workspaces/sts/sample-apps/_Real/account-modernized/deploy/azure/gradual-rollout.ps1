# Gradual Rollout Orchestration Script for RA Funding Invoices
...
# Configuration
$appConfigName = "ra-funding-invoices-config-$Environment"
$appInsightsName = "ra-funding-invoices-insights-$Environment"
...
Write-Host "║  RA Funding Invoices - Gradual Rollout Orchestration           ║" -ForegroundColor Magenta
Write-Host "╚════════════════════════════════════════════════════════════════╝" -ForegroundColor Magenta
Write-Host ""
...
| where cloud_RoleName == 'ra-funding-invoices-api'
| summarize 
    TotalRequests = count(),
...
if ($rollbackTriggered) {
    ...
    Write-Host ""
    Write-Critical "ROLLBACK COMPLETE - ALL TRAFFIC ROUTED TO MOCK DATA LAYER"
    Write-Host ""
...
if ($nextPercentage) {
    ...
    Write-Host "╔════════════════════════════════════════════════════════════════╗" -ForegroundColor Magenta
    Write-Host "║  🎉 MIGRATION COMPLETE - 100% EF CORE TRAFFIC                  ║" -ForegroundColor Magenta
    Write-Host "╚════════════════════════════════════════════════════════════════╝" -ForegroundColor Magenta
    Write-Host ""
