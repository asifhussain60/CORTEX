...
using Account.FundingInvoices.API.Middleware;
using Account.FundingInvoices.Core.FeatureManagement;
using Account.FundingInvoices.Core.Interfaces;
using Account.FundingInvoices.Core.Monitoring;
using Account.FundingInvoices.Core.Security;
using Account.FundingInvoices.Infrastructure.FeatureManagement;
using Account.FundingInvoices.Infrastructure.Mock;
using Account.FundingInvoices.Infrastructure.Monitoring;
...
using Account.FundingInvoices.Infrastructure.Security;
using Account.FundingInvoices.Infrastructure.EFCore;
using Account.FundingInvoices.Core.Services;
using Account.FundingInvoices.Infrastructure.Services;
using Account.FundingInvoices.Core.Adapters;
using Account.FundingInvoices.Infrastructure.Adapters;
using Account.FundingInvoices.Core.DTOs;
using Account.FundingInvoices.Core.Validators;
...
builder.Services.AddKeyedScoped<IFundingInvoiceRepository, Account.FundingInvoices.Infrastructure.EFCore.Repositories.EFCoreFundingInvoiceRepository>("EFCore");
builder.Services.AddKeyedScoped<IFundingBatchRepository, Account.FundingInvoices.Infrastructure.EFCore.Repositories.EFCoreFundingBatchRepository>("EFCore");
builder.Services.AddKeyedScoped<ISubaccountRepository, Account.FundingInvoices.Infrastructure.EFCore.Repositories.EFCoreSubaccountRepository>("EFCore");
builder.Services.AddKeyedScoped<ICashInOutRepository, Account.FundingInvoices.Infrastructure.EFCore.Repositories.EFCoreCashInOutRepository>("EFCore");
builder.Services.AddKeyedScoped<IUnitOfWork, Account.FundingInvoices.Infrastructure.EFCore.Repositories.EFCoreUnitOfWork>("EFCore");
