...
namespace Account.FundingInvoices.Infrastructure.Mock;
...
public class MockCashInOutRepository : ICashInOutRepository
{
    ...
    public Task<IEnumerable<CashInOut>> GetBySubaccountIdAsync(string subaccountId)
    {
        var transactions = _transactions.Values.Where(t => t.SubaccountId == subaccountId);
        return Task.FromResult(transactions);
    }
