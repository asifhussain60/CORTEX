...
namespace Account.FundingInvoices.ContractTests.Reporting;
...
public class VerificationReportGenerator
{
    ...
    private string GenerateExecutiveSummary()
    {
        ...
        sb.AppendLine($"    <p><strong>Migration Project:</strong> Account Funding Invoices (Product.Account.Api)</p>");
        sb.AppendLine($"    <p><strong>Verification Duration:</strong> {_report.Duration:hh\\:mm\\:ss}</p>");
        sb.AppendLine();
        sb.AppendLine("    <h2>Executive Summary</h2>");
        sb.AppendLine("    <p>");
        sb.AppendLine($"        This report documents the contract verification results for Phase 4a of the Account Funding Invoices migration.");
    ...
    public async Task GenerateMarkdownSummaryAsync(string outputPath)
    {
        ...
        sb.AppendLine($"**Migration Project:** Account Funding Invoices (Product.Account.Api)  ");
