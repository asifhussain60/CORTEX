...
using Account.FundingInvoices.Core.Repositories;
using Account.FundingInvoices.Infrastructure.Services;
using Xunit;

namespace Account.FundingInvoices.Core.Tests.Services.Legacy;

/// <summary>
/// Unit tests for CreateBatchInvoicesAsync (WCF: Updater_CreateAccountFundingInvoices migration)
/// </summary>
