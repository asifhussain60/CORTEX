...
namespace Account.FundingInvoices.IntegrationTests.Middleware;
...
public class DataEncryptionMiddlewareTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Middleware_EncryptionDisabled_PassesThroughWithoutEncryption()
    {
        ...
        var response = await client.GetAsync("/api/fundinginvoices");
    ...
    public async Task Middleware_PostRequest_JsonContent_EncryptsRequestBody()
    {
        ...
        var testData = new
        {
            ...
            Amount = 1500.00m,
            MemberName = "John Doe" // Should be encrypted
        };

        // Act
        var response = await client.PostAsJsonAsync("/api/fundinginvoices", testData);
    ...
    public async Task Middleware_NonJsonRequest_SkipsEncryption()
    {
        ...
        // Act
        var response = await client.PostAsync("/api/fundinginvoices", content);
