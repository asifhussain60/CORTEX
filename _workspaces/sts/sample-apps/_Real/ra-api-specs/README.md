# RA API Specifications - Platform.Classic

**Purpose:** Generated specifications for legacy RA APIs  
...
This folder contains **generated outputs** from CORTEX Lens for RA API modernization.
