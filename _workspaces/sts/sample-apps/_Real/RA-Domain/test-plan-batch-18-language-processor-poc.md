...
**Source Code:** `Libs/App.Example.Domain/Entities/PaymentAccount.cs`
...
2. **Rollover Processing:** Implemented in `ExampleDomainService.CalculateForefeitAndCarryoverBalanceEOY` [CODE]
...
- **ExampleDomainService:** Year-end rollover/expiration calculations [CODE]
- **ExampleBalanceService:** Balance inquiry and validation [CODE]
- **ExampleScheduledService:** Autopay request scheduling [CODE]
