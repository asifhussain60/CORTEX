...
**Purpose:** Deep domain analysis for Product.PaymentAccounts repository
...
# Repository access
Test-Path "C:\PROJECTS\Product.PaymentAccounts"  # Should return True
```

### Quick Scan (30 seconds)
```powershell
# Structural analysis only
.\scripts\01_quick_scan.ps1 -RepoPath "C:\PROJECTS\Product.PaymentAccounts"
```

### Full Analysis (17.58 hours - batched execution)
```powershell
# Execute all 20 batches
python scripts\06_master_orchestrator.py --repo-path "C:\PROJECTS\Product.PaymentAccounts" --execute-all
```
...
```powershell
# Verify path
Test-Path "C:\PROJECTS\Product.PaymentAccounts"
