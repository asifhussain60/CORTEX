...
**Service:** `ExampleDomainService` (event publishing)  
...
|----------------|-----------|----------|------------|
| **Account Management** | 10+ | ExampleBalanceService | Medium |
| **Request Processing** | 8+ | ExampleBalanceService | High |
| **Balance Tracking** | 6+ | ExampleBalanceService | Medium |
| **Year-End Processing** | 5+ | ExampleDomainService | **Critical** |
| **Plan Management** | 4+ | ExampleLedgerService | Low |
| **Payment & Payment** | 6+ | ExampleBalanceService | High |
| **Audit & Compliance** | 8+ | ExampleDomainService | **Critical** |
...
**Primary Sources:**
- `rollover-service-methods.json` - ExampleDomainService methods (lines 1-471)
