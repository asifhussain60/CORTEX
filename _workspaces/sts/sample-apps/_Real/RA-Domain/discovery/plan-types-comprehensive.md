...
**Repository:** C:\PROJECTS\Product.Example  
...
- **Rollover Logic:** `ExampleDomainService.CalculateForefeitAndCarryoverBalanceEOY`
...
4. **Expiration processing:** Automated at year-end (ExampleDomainService)
...
- **Rollover Service:** `ExampleDomainService` (FlexAccount only)
- **Balance Service:** `ExampleBalanceService` (all types)
...
- Most complex year-end processing (ExampleDomainService)
