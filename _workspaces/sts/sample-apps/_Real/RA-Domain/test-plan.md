# AST Scanner Validation Plan: Payment Accounts Domain
...
**Goal:** Validate CORTEX's AST scanning capabilities by reverse engineering the Payment Accounts codebase.
...
**Tasks:**
- [ ] Verify path exists: `C:\PROJECTS\Product.Example`
...
# Example: python -m src.orchestrators.ast_scanner --target "C:\PROJECTS\Product.Example"
...
cortex scan-domain --path "C:\PROJECTS\Product.Example" --output "cortex-brain/admin/RA-Domain"
```
