...
Purpose: Scan Product.Example to identify high-value data points
...
class RABusinessValueScanner:
    ...
    def _scan_business_functions(self) -> Dict[str, Any]:
        ...
        services_dir = self.repo_path / 'Libs' / 'App.Example.Domain' / 'Services'
    ...
    def _analyze_test_coverage(self) -> Dict[str, Any]:
        ...
        # Analyze by layer
        layers = {
            'Domain': ('Libs/App.Example.Domain', 'Libs/App.Organization.Domain'),
            'Services': ('Services/',),
    ...
    def _generate_onboarding_metrics(self) -> Dict[str, Any]:
        ...
        metrics['learning_path'] = [
            ...
            },
            {
                ...
                'description': 'Review domain services, especially ExampleDomainService',
...
def main():
    ...
    parser.add_argument('--repo-path', default='C:/PROJECTS/Product.Example',
