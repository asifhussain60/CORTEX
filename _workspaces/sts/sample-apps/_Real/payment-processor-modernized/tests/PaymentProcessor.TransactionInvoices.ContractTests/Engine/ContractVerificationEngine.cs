...
using PaymentProcessor.TransactionInvoices.ContractTests.Reporting;
...
public class ContractVerificationEngine
{
    ...
    private async Task<WcfResponse> ExecuteWcfOperationAsync(string transaction, object request)
    {
        ...
        {
            "XAddTransactionInvoice" => await _wcfProxy.AddTransactionInvoiceAsync(request),
            "XGenerateTransactionInvoice" => await _wcfProxy.GenerateTransactionInvoiceAsync(request),
            "Updater_CreatePaymentTransactionInvoices" => await _wcfProxy.CreateBatchInvoicesAsync(request),
            "XCloseTransactionBatch" => await _wcfProxy.CloseTransactionBatchAsync(request),
            "XUpdateTransactionBatch" => await _wcfProxy.UpdateTransactionBatchAsync(request),
    ...
    private RestEndpoint GetRestEndpoint(string wcfTransaction)
    {
        ...
        {
            "XAddTransactionInvoice" => new RestEndpoint { Method = "POST", Path = "/api/v1/transaction-invoices" },
            "XGenerateTransactionInvoice" => new RestEndpoint { Method = "POST", Path = "/api/v1/transaction-invoices/generate" },
            "Updater_CreatePaymentTransactionInvoices" => new RestEndpoint { Method = "POST", Path = "/api/v1/transaction-invoices/batch" },
            "XCloseTransactionBatch" => new RestEndpoint { Method = "POST", Path = "/api/v1/transaction-batches/close" },
            "XUpdateTransactionBatch" => new RestEndpoint { Method = "PUT", Path = "/api/v1/transaction-batches/{id}" },
