...
public class MockTransactionInvoiceRepositoryTests
{
    private readonly MockTransactionInvoiceRepository _repository;

    public MockTransactionInvoiceRepositoryTests()
    {
        _repository = new MockTransactionInvoiceRepository();
    }
    ...
    {
        // Arrange
        await _repository.CreateAsync(new TransactionInvoice
        {
            InvoiceId = "INV-001",
            BatchId = "BATCH-001",
            AccountCategoryId = "SUB-001",
    ...
    [Fact]
    public async Task GetByAccountCategoryIdAsync_ShouldReturnMatchingInvoices()
    {
        // Arrange
        await _repository.CreateAsync(new TransactionInvoice
        {
    ...
    {
        // Arrange
        _repository.Seed(new TransactionInvoice
        {
            InvoiceId = "INV-OLD",
            BatchId = "BATCH-001",
            AccountCategoryId = "SUB-001",
