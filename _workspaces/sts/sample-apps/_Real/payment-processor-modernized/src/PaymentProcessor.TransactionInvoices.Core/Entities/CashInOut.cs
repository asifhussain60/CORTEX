...
/// <summary>
/// Represents a cash in/out transaction for transaction batches.
...
public class CashInOut
{
    ...
    /// <summary>
    /// Foreign key to TransactionBatch. The batch this transaction is associated with.
    /// </summary>
    [Required]
    [Column("BatchId")]
    ...
    /// <summary>
    /// Navigation property to the associated transaction batch.
    /// </summary>
