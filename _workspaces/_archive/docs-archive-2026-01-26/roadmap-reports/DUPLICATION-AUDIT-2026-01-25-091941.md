...
📅 Generated: 2026-01-25T09:19:41.889598
...
✅ Total Unique Classes: 448
✅ Total Unique Functions: 352
⚠️  CORE-035 Violations Found: 239
📈 Duplicate Items: 141
...
❌ CLASS: AuditEventType
   ...
   [2] cortex/brain/observability/audit_trail.py:27
...
❌ CLASS: ComponentStatus
   Locations: 2 implementations found
   [1] cortex/tools/unwired_component_detector.py:31
   [2] cortex/tools/wiring_validation_agent.py:26
...
❌ CLASS: ReflectionStatus
   Locations: 2 implementations found
   [1] cortex/core/intent/intent_reflection_protocol.py:22
...
❌ CLASS: VariableType
   ...
   [3] cortex/templates/knowledge_schema.py:13
...
❌ FUNCTION: main
   Locations: 63 implementations found
   [1] cortex/documentation/discovery_agent.py:350
   [2] cortex/tools/unwired_component_detector.py:508
   ...
   [11] cortex/tools/wiring_validation_agent.py:674
   [12] cortex/scripts-root-archive/fix_12_issues.py:237
   [13] cortex/scripts-root-archive/tdd_gap_analysis.py:49
   [14] cortex/scripts-root-archive/validate_mcp.py:29
   [15] cortex/scripts-root-archive/ac_fix_db_persist_001.py:290
   [16] cortex/scripts-root-archive/update_imports.py:394
   [17] cortex/scripts-root-archive/migration-validator.py:183
   [18] cortex/scripts-root-archive/test-performance-auditor.py:438
   [19] cortex/scripts-root-archive/migrate_folder_structure.py:354
   [20] cortex/scripts-root-archive/regenerate_audit_log.py:128
   [21] cortex/scripts-root-archive/test-analytics.py:240
   [22] cortex/scripts-root-archive/setup_cortex_hub.py:516
   [23] cortex/scripts-root-archive/validate_imports.py:195
   [24] cortex/scripts-root-archive/detect_hanging_tests.py:57
   [25] cortex/scripts-root-archive/utilities/phase_b1_update.py:39
   [26] cortex/scripts-root-archive/utilities/launch-dashboard.py:48
   [27] cortex/scripts-root-archive/utilities/phase_b3_update.py:76
   [28] cortex/scripts-root-archive/utilities/phase_b2_update.py:63
   [29] cortex/scripts-root-archive/utilities/run-cortex-vacuum.py:222
   [30] cortex/scripts-root-archive/deployment/sanitize_governance_db.py:229
   [31] cortex/scripts-root-archive/deployment/generate_templates.py:226
   [32] cortex/scripts-root-archive/deployment/track_sanitize_state.py:342
   [33] cortex/scripts-root-archive/deployment/validate_sanitization.py:211
   [34] cortex/scripts-root-archive/maintenance/phase_14_completion.py:393
   [35] cortex/scripts-root-archive/maintenance/log_phase_remediation_07_audit.py:80
   [36] cortex/scripts-root-archive/maintenance/update_imports.py:284
   [37] cortex/scripts-root-archive/maintenance/phase_13_domain_completion.py:494
   [38] cortex/scripts-root-archive/maintenance/migrate_folder_structure.py:503
   [39] cortex/scripts-root-archive/maintenance/migrate_knowledge_to_tier3.py:176
   [40] cortex/scripts-root-archive/maintenance/rebuild_phase_yaml_with_evidence.py:267
   [41] cortex/scripts-root-archive/maintenance/consolidate_phases.py:175
   [42] cortex/scripts-root-archive/maintenance/record_phase10_audit.py:10
   [43] cortex/scripts-root-archive/maintenance/log_phase_03_audit.py:80
   [44] cortex/scripts-root-archive/maintenance/init_db.py:127
   [45] cortex/scripts-root-archive/validation/validate_phase_deliverables.py:332
   [46] cortex/scripts-root-archive/validation/validate_phase_sync.py:313
   [47] cortex/mcp/__main__.py:28
   [48] cortex/orchestrators/onboarding/mcp_bootstrapper.py:269
   [49] cortex/orchestrators/onboarding/toolchain_validator.py:248
   [50] cortex/orchestrators/onboarding/setup_orchestrator.py:360
   [51] cortex/orchestrators/onboarding/dependency_resolver.py:276
   [52] cortex/orchestrators/onboarding/vscode_configurator.py:231
   [53] cortex/testing/violation_detector.py:238
   [54] cortex/scripts/verify_environment.py:280
   [55] cortex/scripts/autonomous_phases_4_7.py:400
   [56] cortex/scripts/verify-cortex-installation.py:181
   [57] cortex/brain/ci_cd/compliance_gate.py:205
   [58] cortex/brain/mcp/tools/validate_consolidation.py:506
   [59] cortex/brain/mcp/tools/consolidate.py:557
   [60] cortex/brain/cli/governance_cli.py:396
   [61] cortex/brain/dashboard/launch.py:113
   [62] cortex/brain/dashboard/serve-cortex-dashboard.py:391
   [63] cortex/brain/governance/zero_breaking_changes_verifier.py:341
...
❌ FUNCTION: orchestrator
   ...
   [3] cortex/brain/core/decorators/orchestrator.py:154
...
❌ FUNCTION: validate_schema
   ...
   [2] cortex/common/validators.py:212
...
⚠️  NON-COMPLIANT - 239 violations
