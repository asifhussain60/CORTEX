...
❌ CLASS: AuditAction
   Locations: 2 implementations found
   [1] cortex/brain/core/governance_database.py:56
   [2] cortex/brain/core/observability/audit_trail.py:24

❌ CLASS: AuditEventType
   Locations: 4 implementations found
   [1] cortex/confirmation/governance.py:15
   [2] cortex/orchestrators/core/planning_audit_trail.py:47
   [3] cortex/brain/core/governance_audit_logger.py:35
   [4] cortex/brain/observability/audit_trail.py:27
...
❌ CLASS: ChallengeType
   ...
   [2] cortex/orchestrators/response/unified_response_composer.py:71
   [3] cortex/orchestrators/domain/planning_orchestrator.py:55
...
❌ CLASS: CircuitBreakerState
   Locations: 3 implementations found
   [1] cortex/orchestrators/core/smart_analyzer.py:30
   [2] cortex/brain/tier2/resilience/__init__.py:827
   [3] cortex_brain/tier2/resilience.py:897
...
❌ CLASS: DisagreementType
   Locations: 2 implementations found
   [1] cortex/orchestrators/core/challenge_engine.py:35
   [2] cortex/orchestrators/core/challenge_engine_plugins.py:21
...
❌ CLASS: ExecutionMode
   ...
   [2] cortex/orchestrators/core/parallel_turn_executor.py:29
   [3] cortex/orchestrators/adaptive/execution_modes.py:18
   [4] cortex/orchestrators/adaptive/unified_adaptive_layer.py:37
   [5] cortex_brain/tier2/hallucination_prevention/execution_sandbox.py:253
...
❌ CLASS: IntentType
   ...
   [2] cortex/orchestrators/core/intent_router.py:36
...
❌ CLASS: PhaseState
   ...
   [4] cortex/brain/core/state_machine.py:37
...
❌ CLASS: RiskLevel
   ...
   [2] cortex/orchestrators/domain/enhanced_planning_orchestrator.py:72
   [3] cortex/brain/domain_orchestrators/business/base.py:27
...
❌ CLASS: SeverityLevel
   ...
   [2] cortex/orchestrators/domain/enhanced_refactoring_orchestrator.py:58
   [3] cortex/brain/core/input_validator.py:25
   [4] cortex/brain/core/observability/performance_profiler.py:28
   [5] cortex/brain/core/knowledge/change_detection.py:53
...
❌ CLASS: ViolationType
   Locations: 4 implementations found
   [1] cortex/orchestrators/domain/enhanced_refactoring_orchestrator.py:48
   [2] cortex/testing/tdd_enhancement_layer1_precommit.py:19
   [3] cortex_brain/tier2/security/__init__.py:16
   [4] cortex_brain/tier2/hallucination_prevention/boundary_rules.py:15
...
❌ FUNCTION: main
   Locations: 76 implementations found
   ...
   [12] cortex/tools/toolkit/copilot-request-generator.py:180
   [13] cortex/tools/toolkit/duplication_audit.py:251
   [14] cortex/tools/toolkit/run_integration_tests_with_timeout.py:97
   [15] cortex/tools/toolkit/update_imports.py:229
   [16] cortex/tools/toolkit/execute-track-eval-silent.py:295
   [17] cortex/tools/toolkit/generate-governance-data.py:149
   [18] cortex/tools/toolkit/generate-lifecycle-data.py:162
   [19] cortex/tools/toolkit/generate-tdd-cycle-data.py:280
   [20] cortex/scripts-root-archive/fix_12_issues.py:237
   [21] cortex/scripts-root-archive/tdd_gap_analysis.py:49
   [22] cortex/scripts-root-archive/validate_mcp.py:29
   [23] cortex/scripts-root-archive/ac_fix_db_persist_001.py:290
   [24] cortex/scripts-root-archive/update_imports.py:394
   [25] cortex/scripts-root-archive/migration-validator.py:183
   [26] cortex/scripts-root-archive/test-performance-auditor.py:438
   [27] cortex/scripts-root-archive/migrate_folder_structure.py:358
   [28] cortex/scripts-root-archive/regenerate_audit_log.py:128
   [29] cortex/scripts-root-archive/test-analytics.py:240
   [30] cortex/scripts-root-archive/setup_cortex_hub.py:516
   [31] cortex/scripts-root-archive/validate_imports.py:195
   [32] cortex/scripts-root-archive/detect_hanging_tests.py:57
   [33] cortex/scripts-root-archive/analysis-tools/transform_002_redundancy_analyzer.py:286
   [34] cortex/scripts-root-archive/utilities/phase_b1_update.py:39
   [35] cortex/scripts-root-archive/utilities/launch-dashboard.py:48
   [36] cortex/scripts-root-archive/utilities/phase_b3_update.py:76
   [37] cortex/scripts-root-archive/utilities/phase_b2_update.py:63
   [38] cortex/scripts-root-archive/utilities/run-cortex-vacuum.py:222
   [39] cortex/scripts-root-archive/deployment/sanitize_governance_db.py:229
   [40] cortex/scripts-root-archive/deployment/generate_templates.py:226
   [41] cortex/scripts-root-archive/deployment/track_sanitize_state.py:351
   [42] cortex/scripts-root-archive/deployment/validate_sanitization.py:211
   [43] cortex/scripts-root-archive/maintenance/phase_14_completion.py:393
   [44] cortex/scripts-root-archive/maintenance/log_phase_remediation_07_audit.py:80
   [45] cortex/scripts-root-archive/maintenance/update_imports.py:284
   [46] cortex/scripts-root-archive/maintenance/phase_13_domain_completion.py:494
   [47] cortex/scripts-root-archive/maintenance/migrate_folder_structure.py:503
   [48] cortex/scripts-root-archive/maintenance/migrate_knowledge_to_tier3.py:176
   [49] cortex/scripts-root-archive/maintenance/rebuild_phase_yaml_with_evidence.py:267
   [50] cortex/scripts-root-archive/maintenance/consolidate_phases.py:175
   [51] cortex/scripts-root-archive/maintenance/record_phase10_audit.py:10
   [52] cortex/scripts-root-archive/maintenance/log_phase_03_audit.py:80
   [53] cortex/scripts-root-archive/maintenance/init_db.py:127
   [54] cortex/scripts-root-archive/validation/validate_phase_deliverables.py:332
   [55] cortex/scripts-root-archive/validation/validate_phase_sync.py:313
   [56] cortex/mcp/__main__.py:28
   [57] cortex/cli/health_check.py:33
   ...
   [73] cortex/brain/knowledge/cache_builder.py:54
   [74] cortex/brain/governance/zero_breaking_changes_verifier.py:341
   [75] cortex/infrastructure/test_isolation.py:187
   [76] cortex/infrastructure/database_log_rotation.py:313
...
⚠️  NON-COMPLIANT - 285 violations
