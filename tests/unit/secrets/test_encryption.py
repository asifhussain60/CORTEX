...
class TestEncryptionPerformance:
    ...
    def test_encryption_under_10ms(self) -> None:
        ...
        from cortex.infrastructure.secrets.encryption import derive_key
        key = derive_key(master_key)
        
        # Now test just the encryption (no key derivation)
        from cortex.infrastructure.secrets.encryption import EncryptedValue
    ...
    def test_decryption_under_10ms(self) -> None:
        ...
        from cortex.infrastructure.secrets.encryption import EncryptedValue, derive_key
        from cryptography.hazmat.primitives.ciphers.aead import AESGCM
