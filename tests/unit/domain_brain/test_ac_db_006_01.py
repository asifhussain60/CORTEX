...
from cortex_intelligence.domain_brain.domain_brain_models import Domain, Entity, EntityType, AuditOperationType
...
class TestArchitectureDocumentation:
    ...
    def test_component_separation(self) -> None:
        ...
        from cortex_intelligence.domain_brain.domain_brain_models import Domain
        from cortex.domain_brain.api import DomainBrainAPI
...
class TestComplianceMatrix:
    ...
    def test_core_028_naming_conventions_compliance(self) -> None:
        ...
        from cortex_intelligence.domain_brain.domain_brain_models import (
            Domain,
            Entity,
            Conflict,
            EntityType,
