...
class TestGoldenJSONCleanup:
    ...
    def test_report_jsons_relocated(
        ...
        # Execute vacuum
        from cortex_intelligence.memory.tier1_learned.orchestrators.cleaners.root_artifacts import RootArtifactsCleaner
...
class TestGoldenMarkdownCleanup:
    ...
    def test_sprawl_markdown_deleted(
        ...
        # Execute vacuum
        from cortex_intelligence.memory.tier1_learned.orchestrators.cleaners.markdown_sprawl import MarkdownSprawlCleaner
