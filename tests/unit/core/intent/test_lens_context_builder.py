...
from cortex.orchestrators.core.intent_router.lens_context_builder import (
    LENSContextBuilder,
    ContextNode,
    ContextEdge,
    KnowledgeGraph,
...
class TestContextSerialization:
    ...
    def test_context_from_dict(self, sample_ast_findings):
        ...
        from cortex.orchestrators.core.intent_router.lens_context_builder import LENSContext
