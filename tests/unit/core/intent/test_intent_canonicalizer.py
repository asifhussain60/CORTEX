...
class TestIntentTypeExtraction:
    ...
    def test_detect_implement_intent(
        ...
        from cortex.orchestrators.core.intent_router.intent_canonicalizer import IntentCanonicalizer
...
class TestIntentTypes:
    ...
    def test_all_intent_types_defined(self) -> None:
        ...
        from cortex.orchestrators.core.intent_router.intent_canonicalizer import IntentType
