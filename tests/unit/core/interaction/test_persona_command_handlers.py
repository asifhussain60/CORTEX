...
@pytest.fixture
def role_resolver(persona_loader: "PersonaLoader") -> "RoleResolver":
    """Create a test role resolver"""
    return RoleResolver(loader=persona_loader)


@pytest.fixture
def persona_injector(persona_loader: "PersonaLoader") -> "PersonaInjector":
...
@pytest.fixture
def command_handlers(master_orchestrator: "MasterOrchestrator") -> "PersonaCommandHandlers":
...
class TestPersonaCommandHandlers:
    ...
    def test_handlers_initialization(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_handle_command_routes_persona(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_handle_command_routes_detail(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test command routing for /detail"""
        result = command_handlers.handle_command("/detail", "full")
        assert result.success is True
        assert result.depth_changed is True

    def test_handle_command_unknown(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test unknown command handling"""
        result = command_handlers.handle_command("/unknown", "arg")
        assert result.success is False
        assert "Unknown command" in result.message

    def test_persona_command_no_args_shows_current(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_persona_command_empty_args_shows_current(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test /persona with empty args shows current persona"""
        result = command_handlers._handle_persona_command("")
        assert result.success is True
        assert "Current persona" in result.message

    def test_persona_command_reset(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test /persona reset"""
        # First set a persona
    ...
    def test_persona_command_save(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test /persona save"""
    ...
    def test_persona_command_set_engineer(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_persona_command_set_business_leader(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_persona_command_set_tech_lead(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test /persona tech_lead"""
        result = command_handlers._handle_persona_command("tech_lead")
        assert result.success is True
        assert result.persona_changed is True

    def test_persona_command_invalid_persona(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_detail_command_no_args_shows_current(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_detail_command_empty_args_shows_current(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test /detail with empty args shows current depth"""
        result = command_handlers._handle_detail_command("")
        assert result.success is True
        assert "Current depth" in result.message

    def test_detail_command_set_executive(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_detail_command_set_full(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test /detail full"""
        result = command_handlers._handle_detail_command("full")
        assert result.success is True
        assert result.depth_changed is True

    def test_detail_command_set_detailed(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test /detail detailed"""
        result = command_handlers._handle_detail_command("detailed")
        assert result.success is True
        assert result.depth_changed is True

    def test_detail_command_sticky(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_detail_command_sticky_multiple_words(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_detail_command_invalid_depth(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_detail_command_temporary_vs_sticky(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_parse_command_persona(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test parsing /persona command"""
        cmd, args = command_handlers.parse_command_from_message("/persona engineer")
        assert cmd == "/persona"
        assert args == "engineer"

    def test_parse_command_role_alias(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_parse_command_detail(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test parsing /detail command"""
        cmd, args = command_handlers.parse_command_from_message("/detail full")
        assert cmd == "/detail"
        assert args == "full"

    def test_parse_command_depth_alias(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_parse_command_no_command(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_parse_command_persona_no_args(self, command_handlers: "PersonaCommandHandlers") -> None:
        """Test parsing /persona with no args"""
        cmd, args = command_handlers.parse_command_from_message("/persona")
        assert cmd == "/persona"
        assert args is None

    def test_parse_command_sticky_detail(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_command_sequence_persona_then_detail(self, command_handlers: "PersonaCommandHandlers") -> None:
    ...
    def test_handle_command_integration(self, command_handlers: "PersonaCommandHandlers") -> None:
