"""
RED phase tests — LegacyModernizationOrchestrator (Phase 14 / CORE-008).

Tests are written BEFORE implementation. All tests must FAIL at this stage.
Implementation target: cortex/orchestrators/domain/legacy_modernization_orchestrator.py
"""
...
def orchestrator(mock_workflow_engine):
    """Instantiate LegacyModernizationOrchestrator with injected engine."""
    from cortex.orchestrators.domain.legacy_modernization_orchestrator import (
        LegacyModernizationOrchestrator,
    )
    return LegacyModernizationOrchestrator(workflow_engine=mock_workflow_engine)
...
class TestMCPRouting:
    """AC-PHASE14-006 — cortex_process_request routes to LegacyModernizationOrchestrator."""
