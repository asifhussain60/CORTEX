...
import cortex.core.knowledge.graph.interface as interface_module
import cortex.core.knowledge.graph.mock_adapter as mock_module
import cortex.core.knowledge.graph.sqlite_adapter as sqlite_module
import cortex.core.knowledge.graph.constraint_validator as validator_module
...
class TestGovernanceNonBreakingDesign:
    ...
    def test_kg_module_optional_import(self) -> None:
        ...
        try:
            from cortex.core.knowledge.graph import IGraphAdapter
    ...
    def test_no_circular_imports(self) -> None:
        ...
        try:
            import cortex.core.knowledge.graph
