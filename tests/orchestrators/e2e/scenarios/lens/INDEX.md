# CORTEX LENS Golden Test Index

**Quick reference for all 38 golden test scenarios**

## 📦 Core Capabilities (11 tests)

| ID | Name | Category | Status | Priority |
|----|------|----------|--------|----------|
| 04 | Python AST Analysis | Core | ✅ Defined | P0 |
| 05 | .NET Solution Analysis | Core | ✅ Defined | P0 |
| 06 | Git History Analysis | Core | ✅ Defined | P0 |
| 07 | Config Extraction | Core | ✅ Defined | P0 |
| 08 | API Discovery | Core | ✅ Defined | P0 |
...
| 31 | MSBuild Graph | .NET | 📝 Planned | P1 |
...
| ID | Name | Category | Status | Priority |
|----|------|----------|--------|----------|
| 35 | Architecture Viz | Visual | 📝 Planned | P2 |
| 36 | KG Export | Visual | 📝 Planned | P2 |

## 🔐 Security (2 tests)

| ID | Name | Category | Status | Priority |
|----|------|----------|--------|----------|
| 37 | Secret Detection | Security | ✅ Defined | P0 |
| 38 | Code Smells | Security | 📝 Planned | P1 |
...
- **Defined:** 14 (37%)
- **Planned:** 24 (63%)
- **P0 Priority:** 12 scenarios
- **P1 Priority:** 18 scenarios
- **P2 Priority:** 8 scenarios
