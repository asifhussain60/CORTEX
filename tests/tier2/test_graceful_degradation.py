...
class TestGracefulDegradationFramework:
    ...
    def test_partial_functionality_disable_feature(self):
        ...
        from cortex_intelligence.memory.tier2_adaptive.resilience import PartialFunctionalityMode
    ...
    def test_degraded_response_wrapper(self):
        ...
        from cortex_intelligence.memory.tier2_adaptive.resilience import DegradedResponse
    ...
    def test_component_failure_exception(self):
        ...
        from cortex_intelligence.memory.tier2_adaptive.resilience import ComponentFailure
