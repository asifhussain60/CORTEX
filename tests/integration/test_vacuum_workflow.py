...
class TestVacuumWorkflow:
    ...
    def test_vacuum_orchestrator_integration(self):
        ...
        from cortex_intelligence.memory.tier1_learned.orchestrators.cleaners import RootDatabaseCleaner
...
class TestCleanerPluginArchitecture:
    ...
    def test_cleaner_interface_imported(self):
        ...
        sys.path.insert(0, str(CORTEX_ROOT))
        from cortex_intelligence.memory.tier1_learned.orchestrators.cleaners import CleanerInterface
    ...
    def test_cleaner_registry_imported(self):
        ...
        sys.path.insert(0, str(CORTEX_ROOT))
        from cortex_intelligence.memory.tier1_learned.orchestrators.cleaners import CleanerRegistry
