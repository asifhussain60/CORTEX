...
from cortex.intelligence.onboarded_repos import ProfileStore, RepositoryProfile
    ...
    def test_orchestrator_triggers_hook_on_profile_save(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            with patch.object(orchestrator, '_get_dashboard_hook', return_value=mock_hook):
                ...
                assert event.repo_name == "TEST_INTEGRATION"
...
# AC_COMPLETE: AC-PHASE28-S5-012 ✅ Integration test suite complete (8 tests)
