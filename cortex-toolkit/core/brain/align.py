"""
CORTEX Brain Operation: Align

This is a delegator to the CLI wrapper in the toolkit.
For the actual implementation, see: cortex-toolkit/cli/wrappers/align_wrapper.py
"""
import sys
...
from cli.wrappers.align_wrapper import AlignWrapper
