"""
CORTEX Brain Operation: Healthcheck

This is a delegator to the CLI wrapper in the toolkit.
For the actual implementation, see: cortex-toolkit/cli/wrappers/healthcheck_wrapper.py
"""
import sys
...
from cli.wrappers.healthcheck_wrapper import HealthCheckWrapper
