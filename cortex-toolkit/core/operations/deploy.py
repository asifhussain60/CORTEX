"""
CORTEX System Operation: Deploy

This is a delegator to the CLI wrapper in the toolkit.
For the actual implementation, see: cortex-toolkit/cli/wrappers/deploy_wrapper.py
"""
import sys
...
from cli.wrappers.deploy_wrapper import DeployWrapper
