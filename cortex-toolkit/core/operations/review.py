"""
CORTEX System Operation: Review

This is a delegator to the CLI wrapper in the toolkit.
For the actual implementation, see: cortex-toolkit/cli/wrappers/review_wrapper.py
"""
import sys
...
from cli.wrappers.review_wrapper import ReviewWrapper
