...
def launch_external_terminal() -> bool:
    ...
    print("≡ƒÜÇ Launching CORTEX Dashboard in external terminal...")
    ...
    try:
        if os_type == "macos":
            ...
            print("Γ£à Launched in Terminal.app")
            ...
            print("Γ£à Launched in PowerShell")
            ...
            for terminal_cmd, terminal_name in terminals:
                try:
                    ...
                    print(f"Γ£à Launched in {terminal_name}")
                    print(f"   Check {terminal_name} window for server status")
                    return True
                except FileNotFoundError:
                    continue
            
            print("Γ¥î No suitable terminal emulator found")
...
def main() -> int:
    ...
    if success:
        ...
        print()
        print("Γ¥î Launch failed. Try running directly:")
