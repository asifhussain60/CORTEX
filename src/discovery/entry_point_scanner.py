...
class EntryPointScanner:
    ...
    def _infer_orchestrator(self, trigger: str, template_name: str) -> Optional[str]:
        ...
        mappings = {
            ...
            "rollback to": "RollbackOrchestrator",
            "restore to checkpoint": "RollbackOrchestrator",
            "undo to checkpoint": "RollbackOrchestrator",
            "revert to checkpoint": "RollbackOrchestrator",
            "plan ado": "SWAGGEREntryPointOrchestrator",
            "ado story": "SWAGGEREntryPointOrchestrator",
            "ado feature": "SWAGGEREntryPointOrchestrator",
            "create ado work item": "SWAGGEREntryPointOrchestrator",
            "estimate work item": "SWAGGEREntryPointOrchestrator",
            "ux enhancement": "UXEnhancementOrchestrator",
            "analyze ux": "UXEnhancementOrchestrator",
            "ux dashboard": "UXEnhancementOrchestrator",
            "enhance user experience": "UXEnhancementOrchestrator",
            "ado summary": "ADOAgent",
            "ado pr review": "ADOAgent",
            "review ado pr": "ADOAgent",
            ...
            "review architecture": "ArchitectureIntelligenceAgent",
            "analyze architectural health": "ArchitectureIntelligenceAgent",
            "forecast technical debt": "ArchitectureIntelligenceAgent",
            "track architecture evolution": "ArchitectureIntelligenceAgent",
            "architecture report": "ArchitectureIntelligenceAgent",
            ...
            "first time": "OnboardingOrchestrator",
            "new user": "OnboardingOrchestrator",
            ...
            "diagram sync": "DiagramRegenerationOrchestrator",
            "rebuild diagram": "DiagramRegenerationOrchestrator",
