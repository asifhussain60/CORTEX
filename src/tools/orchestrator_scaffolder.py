...
from src.tools.template_parser import ParsedTemplate, TemplateParser
...
from src.orchestrators.base import BaseOrchestrator, ExecutionContext, ExecutionResult
from src.orchestrators.stages import StageResult
...
def register_orchestrator():
    ...
    from src.orchestrators.factory import OrchestratorRegistry
...
'''
    ...
    def test_stage_{safe_name}(self, orchestrator, sample_params):
        ...
        from src.orchestrators.base import ExecutionContext
...
from src.orchestrators.{config.domain}.{module_name} import {class_name}, {class_name}Params
