...
**Key Components:**
- `ExampleDomainService.cs` - Core calculation logic
...
**Key Components:**
- `ExampleBalanceService` - Balance inquiry
...
- `ExampleFlexService` - Plan year logic
...
- `ExampleScheduledService` - Scheduling logic
...
- `ExampleSettingsService` - Rollover logic
