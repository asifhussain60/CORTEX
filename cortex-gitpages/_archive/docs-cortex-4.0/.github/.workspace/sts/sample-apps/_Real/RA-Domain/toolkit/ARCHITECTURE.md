...
```
cortex_brain/dashboards/data/repos/Product.PaymentAccounts/
...
def discover_and_register_ra_domain():
    ...
    output_path = Path('cortex_brain/dashboards/data/repos/Product.PaymentAccounts')
...
orchestrator = RADomainOrchestrator(
    ...
    output_dir='cortex_brain/dashboards/data/repos/Product.PaymentAccounts'
)
...
output:
  base_dir: "cortex_brain/dashboards/data/repos/Product.PaymentAccounts"
  formats:
    - json
    - markdown
...
# 2. Output: cortex_brain/dashboards/data/repos/Product.PaymentAccounts/onedrive-site/
...
2. Auto-update `cortex_brain/dashboards/data/repos/Product.PaymentAccounts/latest.json`
