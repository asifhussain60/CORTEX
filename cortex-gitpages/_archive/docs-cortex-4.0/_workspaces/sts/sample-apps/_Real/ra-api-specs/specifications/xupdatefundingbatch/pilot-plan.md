# Pilot Project: XUpdateFundingBatch Legacy API Modernization
...
**Risk:** MINIMAL
- Won't impact critical funding flows
- Easy to rollback
...
- [ ] Create REST endpoint: `PATCH /api/v1/ra/funding-batches/{id}`
- [ ] Define entities (FundingBatch in Domain)
- [ ] Define repository interface (IFundingBatchRepository in Domain)
- [ ] Design UseCase (UpdateFundingBatchUseCase)
- [ ] Create DTO wrappers (UpdateFundingBatchRequest, FundingBatchResponse)
...
- [ ] Implement Domain entities (FundingBatch)
- [ ] Implement Domain validator
- [ ] Implement UseCase (UpdateFundingBatchUseCase)
- [ ] Implement Repository (FundingBatchRepository with EF Core)
- [ ] Implement Controller (FundingBatchController)
- [ ] Run tests → ALL PASS ✅
...
**Deliverables:**
- `HealthEquity.RA.DomainCore/Entities/FundingBatch.cs`
- `HealthEquity.RA.DomainCore/Repositories/IFundingBatchRepository.cs`
- `HealthEquity.RA.UseCase/Batches/UpdateFundingBatchUseCase.cs`
- `HealthEquity.RA.Data.SqlServer/Repositories/FundingBatchRepository.cs`
- `HealthEquity.RA.Api.Host/Controllers/FundingBatchController.cs`
...
1. **Scale to Complex APIs:**
   - XGenerateFundingInvoice (medium complexity)
   - XCloseFundingBatch (high complexity)
...
3. **Build Knowledge Base:**
   - Add common RA patterns to `domain-patterns.yaml`
...
**Location:** `cortex_brain/documents/pilot-projects/xupdatefundingbatch/`
