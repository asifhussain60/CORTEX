...
public class SchemaValidationReportGenerator
{
    ...
    public SchemaValidationReportGenerator(TransactionInvoicesDbContext dbContext)
    {
    ...
    public async Task<SchemaValidationReport> GenerateReportAsync(CancellationToken cancellationToken = default)
    {
        ...
        await ValidateEntityTypeAsync<TransactionInvoice>(report, "TransactionInvoice", cancellationToken);
        await ValidateEntityTypeAsync<TransactionBatch>(report, "TransactionBatch", cancellationToken);
        await ValidateEntityTypeAsync<AccountCategory>(report, "AccountCategory", cancellationToken);
