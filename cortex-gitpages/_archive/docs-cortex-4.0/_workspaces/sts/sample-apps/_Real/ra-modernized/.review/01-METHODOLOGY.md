...
[← Back to Main Report](./MIGRATION_ANALYSIS_REPORT.md) | [Next: Functionality Analysis →](./02-FUNCTIONALITY-ANALYSIS.md)
...
1. **Legacy Code Discovery** (45 min)
   - Located 5 WCF transaction files in `Segment4/HETransactions/`
...
2. **Modern Code Review** (60 min)
   ...
   - Assessed HIPAA/SOC2 compliance features
...
6. **Security** - HIPAA/SOC2, OWASP Top 10
...
| File | LOC | Purpose |
|------|-----|---------|
| `XAddFundingInvoice.cs` | 138 | Create payroll-based funding invoices |
| `XGenerateFundingInvoice.cs` | 141 | Generate on-demand prefunding invoices |
| `XCloseFundingBatch.cs` | 267 | Close batches, create replenishment invoices |
| `XUpdateFundingBatch.cs` | 52 | Update batch status |
| `XReopenFundingBatch.cs` | 59 | Reopen closed batches |
...
2. **Business Rule Validation**
   ...
   - Exclusion logic (funding batch invoices)
