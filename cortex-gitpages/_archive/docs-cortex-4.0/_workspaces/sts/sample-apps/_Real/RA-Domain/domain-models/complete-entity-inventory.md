...
#### App.Customer.Domain.Entities (5)
...
#### App.Customer.Domain.Entities (10)
...
#### App.Customer.Domain.Entities (9 + 1 enum)
...
- App.Customer.Domain.Entities (line 22)
...
- App.Customer.Domain.Entities (line 26)
...
Multiple entities exist in BOTH `App.Organization.Domain` and `App.Customer.Domain`:
- Organization
- Customer  
- PaymentAccount
- PaymentPlan
...
|-----------|--------------|
| App.Organization.Domain.Entities | 5 |
| App.Customer.Domain.Entities | 25 (includes duplicates from organization side) |
...
1. **[ExcludeFromCodeCoverage]** - Found on:
   - Customer (App.Customer.Domain.Entities)
   - PaymentPlan (App.Customer.Domain.Entities)
