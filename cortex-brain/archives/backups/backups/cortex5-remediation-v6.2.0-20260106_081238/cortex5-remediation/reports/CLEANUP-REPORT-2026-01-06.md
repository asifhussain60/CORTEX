...
**Epic:** cortex5-remediation / GAP-7
...
- **GAP-7 Analysis:** `cortex-brain/documents/planning/active/cortex5-remediation/analysis/GAP-7-INCORRECT-PLAN-LOCATION.md`
- **Epic Manifest:** `cortex-brain/documents/planning/active/cortex5-remediation/epic-manifest.yaml`
