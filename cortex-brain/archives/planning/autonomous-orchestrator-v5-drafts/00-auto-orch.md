...
- **This Plan:** `00-auto-orch.md`
- **Current (Temporary):** `00-auto-orch-v5.md` ⚠️ **RENAME REQUIRED**
...
4. **No version numbers in filename:** Use folder name for versioning (e.g., `autonomous-orchestrator-v5/00-auto-orch.md`)
5. **Sequence + name only:** `00-{name}.md`
6. **Lowercase + hyphens:** `user-auth` not `UserAuth` or `user_auth`

**Examples:**
- ✅ `00-user-auth.md` (14 chars) in folder `user-authentication-v2/`
- ✅ `00-api-refactor.md` (17 chars) in folder `api-refactoring-v3/`
- ✅ `00-glass-ui.md` (15 chars) in folder `glassmorphism-v1/`
- ✅ `00-auto-orch.md` (16 chars) in folder `autonomous-orchestrator-v5/` ← **This plan**
- ❌ `00-auto-orch-v5.md` (18 chars - has version in filename)
- ❌ `00-MASTER-PLAN.md` (17 chars but too generic)

**Renaming Instructions:**
1. Rename: `00-auto-orch-v5.md` → `00-auto-orch.md`
2. Folder already has version: `autonomous-orchestrator-v5/`
3. Update phase file references (if any link back)
4. Update future-structure/ preview files
...
|-----------|---------|------------|---------|--------|
| Master Plan | `{seq}-{name}.md` | 20 chars | `00-auto-orch.md` | ✅ Compliant |
...
**Version Control:**
- ✅ Version in **folder name**: `autonomous-orchestrator-v5/`
- ❌ Version in **file name**: `00-auto-orch-v5.md`
...
# Expected output:
# ✅ Master plan: 00-autonomous-orchestrator-v5-master.md (valid)
...
- ❌ `00-MASTER-PLAN.md` → Should be `00-autonomous-orchestrator-v5-master.md`
...
|-----------|-----------------|----------------|------------------|
| **Master Plan** | >500 lines | 744 lines | ⚠️ ACCEPTABLE (governance docs) |
...
4. **Validation Checklist**
   - [ ] Entry point preserved (00-auto-orch.md)
...
10. ✅ **Production-Ready Filename** - Compliant (`00-auto-orch.md`, 16 chars, no version)
