...
```bash
cortex-brain/documents/planning/active/
├── cortex5-remediation/           ✅ VALID - Main epic
...
- `a19-continue-with-next` (should have continued cortex5-remediation)
- `a19-proceed-with-epic` (should have continued cortex5-remediation)
