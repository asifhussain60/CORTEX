...
python3 -m templates.plan-viewer.generate-plan-viewer --plan-dir cortex-brain/documents/planning/active/cortex-v5-remediation-epic
...
python3 -m src.main "continue cortex-v5-remediation-epic from phase P01"

# View current status
python3 -m src.main "show status for cortex-v5-remediation-epic"
...
**Continue execution:**
```bash
python3 -m src.main "continue cortex-v5-remediation-epic"
```
