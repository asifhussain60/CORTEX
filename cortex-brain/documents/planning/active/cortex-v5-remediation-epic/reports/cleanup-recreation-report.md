...
Clean up and recreate the `cortex-v5-remediation-epic` folder structure to align with CORTEX 5.0 architecture requirements:
...
|--------|--------|---------|
| **Backup old structure** | ✅ Complete | Archived to `cortex-brain/archives/planning/cortex-v5-remediation-epic-backup-20260105-130533/` |
...
**Backup location:** `cortex-brain/archives/planning/cortex-v5-remediation-epic-backup-20260105-130533/`
...
1. **Start Phase P01:**
   ```bash
   python3 -m src.main "start phase P01 for cortex-v5-remediation-epic"
   ```

2. **View live progress:**
   ```bash
   cd cortex-brain/documents/planning/active/cortex-v5-remediation-epic
   python3 launch-plan-viewer.py
   ```
...
### Created Files
- `/cortex-brain/documents/planning/active/cortex-v5-remediation-epic/epic-manifest.yaml`
- `/cortex-brain/documents/planning/active/cortex-v5-remediation-epic/plan-viewer.html`
- `/cortex-brain/documents/planning/active/cortex-v5-remediation-epic/launch-plan-viewer.py`
- `/cortex-brain/documents/planning/active/cortex-v5-remediation-epic/README.md`
- `/cortex-brain/documents/planning/active/cortex-v5-remediation-epic/tracking/progress-tracker.json`
- `/cortex-brain/documents/planning/active/cortex-v5-remediation-epic/tracking/task-registry.json`

### Backup Location
- `/cortex-brain/archives/planning/cortex-v5-remediation-epic-backup-20260105-130533/`
