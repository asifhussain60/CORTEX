...
### Planning & Navigation
1. **`cortex-brain/documents/planning/active/html-glassmorphism-alignment/00-html-view-standardization.md`**
   - Master plan (Phase 16b+ scope)
   - Progress tracking (19/20 phases complete)
   - Phase execution status
   - Success criteria validation

2. **`cortex-brain/documents/planning/completed/cortex-documentation/artifacts/docs-sitemap.md`**
   - Complete site hierarchy (320 pages)
   - Hub page locations
   - Level 1/Level 2 structure
   - Page title reference

### Design Standards
3. **`cortex-brain/documents/standards/glassmorphism-design-standard.md`** (v4.2.9)
...
4. **`docs/panel-viewer.html`** (807 lines)
...
6. **`docs/knowledge/index.html`** (954 lines, reconstructed 2026-01-05)
   - 13 Domain hub Tetris cards (C51 pattern)
   - 35 Best practice guideline cards
   - 4 Related Resources glassmorphism cards
   - Masonry grid layout
   - Card description structure
   - Proper section closure

### CSS Architecture
7. **`docs/assets/css/main.css`** (10,875 lines)
   - `.card-icon-{variant}` classes (Lines 868-950)
   - Color tokens (Lines 23-78)
8. **`docs/assets/css/panel-viewer.css`** (838 lines)
   - Glassmorphism patterns
   - Blur effects, shadows
   - Two-column layouts

### Validation Tools
9. **`cortex-toolkit/validate-icon-title-spacing.ps1`**
   - Icon-title gap enforcement (8px)
   - Inline vs block detection

10. **`cortex-toolkit/check-glassmorphism-compliance.ps1`**
   - Inline vs block detection
