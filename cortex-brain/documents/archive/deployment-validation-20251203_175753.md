...
**Message:** Production validation passed with warnings: 8 items will be excluded by deploy_cortex.py
...
**Message:** ❌ Production content purity FAILED: 35 blocked items found
...
```json
{
  "timestamp": "2025-12-03T17:57:53.355692",
  "execution_time": 0.0009059906005859375,
...
- ❌ Production content purity FAILED: 35 blocked items found
   - 15 admin/dev directories
   - 20 blocked files
   REQUIRED ACTION: Remove all admin/dev content before deployment
   See details for complete list of blocked items
