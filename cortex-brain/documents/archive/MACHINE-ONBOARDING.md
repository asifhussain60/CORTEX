...
git diff HEAD~1 cortex-brain/manifests/orchestrators/planning-system-manifest.yaml
```
...
- `cortex-brain/manifests/orchestrators/planning-system-manifest.yaml` - REQ-005 enhancement
