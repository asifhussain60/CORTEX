...
**Message:** Version consistent: 3.2.1
...
**Message:** Production validation passed with warnings: 30 items will be excluded by deploy_cortex.py
...
```json
{
  ...
  "issues": [
    ...
    "BLOCKED FILE: test_gate18_epm_wiring.py matches blocked pattern 'test_*.py'",
    ...
    "BLOCKED FILE: test_uml_generation.py matches blocked pattern 'test_*.py'",
