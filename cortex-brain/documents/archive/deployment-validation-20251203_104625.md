...
```json
{
  "safe_mocks": [
    ...
    },
    {
      ...
      "pattern": "unittest_mock_import",
      "context": "main_block",
      "snippet": " 442:         \n 443:         # Check if the mock import is inside a string literal (template string)\n 444:         # Pattern: 'from unittest.mock import...' or \"from unittest.mock import...\"\n 445:         if match_line.strip().startswith((\"'from unittest\", '\"from unittest')):\n 446:             # This is a string containing the mock import, not actual import"
    },
    {
      "file": "src\\deployment\\deployment_gates.py",
      "line": 444,
...
```json
{
  "timestamp": "2025-12-03T10:46:25.350259",
