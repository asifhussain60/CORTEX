...
**Message:** ❌ Production content purity FAILED: 37 blocked items found
...
```json
{
  "timestamp": "2025-12-03T18:03:52.218639",
  "execution_time": 0.0009522438049316406,
...
- ❌ Production content purity FAILED: 37 blocked items found
   - 16 admin/dev directories
   - 21 blocked files
   REQUIRED ACTION: Remove all admin/dev content before deployment
   See details for complete list of blocked items
