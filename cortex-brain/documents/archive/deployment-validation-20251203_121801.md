...
**Message:** ❌ Production content purity FAILED: 43 blocked items found
...
```json
{
  "timestamp": "2025-12-03T12:18:01.051428",
  "execution_time": 0.003589630126953125,
...
- ❌ Production content purity FAILED: 43 blocked items found
   - 15 admin/dev directories
   - 28 blocked files
   REQUIRED ACTION: Remove all admin/dev content before deployment
   See details for complete list of blocked items
