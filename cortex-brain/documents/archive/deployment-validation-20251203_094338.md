...
```json
{
  "safe_mocks": [
    ...
    },
    {
      ...
      "pattern": "unittest_mock_import",
      "context": "main_block",
      "snippet": " 454:         \n 455:         # Check if the mock import is inside a string literal (template string)\n 456:         # Pattern: 'from unittest.mock import...' or \"from unittest.mock import...\"\n 457:         if match_line.strip().startswith((\"'from unittest\", '\"from unittest')):\n 458:             # This is a string containing the mock import, not actual import"
    },
    {
      "file": "src\\deployment\\deployment_gates.py",
      "line": 456,
...
**Message:** Git Checkpoint System incomplete: 2 critical issues
...
```json
{
  ...
  "issues": [
    ...
    "Could not validate brain protection rules: while parsing a block mapping\n  in \"D:\\PROJECTS\\CORTEX\\cortex-brain\\brain-protection-rules.yaml\", line 1, column 1\nexpected <block end>, but found '<block sequence start>'\n  in \"D:\\PROJECTS\\CORTEX\\cortex-brain\\brain-protection-rules.yaml\", line 2100, column 5"
  ],
  "passed_checks": 1,
  "total_checks": 6
}
...
**Message:** Production validation passed with warnings: 11 items will be excluded by deploy_cortex.py
...
```json
{
  ...
  "total_blocked_files": 5
}
```

### Gate 11: CORTEX Brain Operational (WARNING)

**Status:** ✅ PASSED

**Message:** CORTEX Brain operational with warnings: 5/6 checks passed
...
```json
{
  ...
  "issues": [
    "brain-protection-rules.yaml is invalid: while parsing a block mapping\n  in \"D:\\PROJECTS\\CORTEX\\cortex-brain\\brain-protection-rules.yaml\", line 1, column 1\nexpected <block end>, but found '<block sequence start>'\n  in \"D:\\PROJECTS\\CORTEX\\cortex-brain\\brain-protection-rules.yaml\", line 2100, column 5"
  ],
  "passed_checks": 5,
  "total_checks": 6,
  "score": "83%"
...
### Gate 15: Production Content Purity (ERROR)

**Status:** ❌ FAILED

**Message:** ❌ Production content purity FAILED: 46 blocked items found
...
```json
{
  ...
  "issues": [
    ...
    "\u26d4 BLOCKED DIR: .cortex/ exists - MUST be excluded before deployment",
    ...
    "\u26d4 BLOCKED FILE: .coverage - admin/dev only",
  ...
  "total_blocked_dirs": 17,
  "total_blocked_files": 29,
  "scan_categories": {
    "admin_dirs": 5,
    "dev_dirs": 1,
    "test_dirs": 5,
...
**Message:** Token budget validation FAILED. Total: 78,764 tokens (Budget: 76,000 tokens). Overage: 2,764 tokens. Deployment BLOCKED until optimization completes.

Violations (2 files):
  • CORTEX.prompt.md: 12,314 / 12,000 tokens (2.6% over)
...
```json
{
  "timestamp": "2025-12-03T09:43:38.435388",
  "execution_time": 0.003714323043823242,
  "total_current_tokens": 78764,
  "total_budget_tokens": 76000,
  "total_overage_tokens": 2764,
  "is_compliant": false,
  "compliant_count": 2,
  "total_count": 4,
  "files": [
    {
      ...
      "current_tokens": 12314,
      "max_tokens": 12000,
      "char_count": 49256,
      "line_count": 942,
      "is_compliant": false,
      "overage_tokens": 314,
      "overage_percent": 2.6166666666666667,
      "reduction_needed": 2.5499431541335067
    },
    {
      "name": "brain-protection-rules.yaml",
      "path": "D:\\PROJECTS\\CORTEX\\cortex-brain\\brain-protection-rules.yaml",
      "current_tokens": 31977,
      "max_tokens": 35000,
      "char_count": 127911,
      "line_count": 2075,
      "is_compliant": true,
      "overage_tokens": -3023,
      "overage_percent": -8.637142857142857,
      "reduction_needed": -9.453669825186854
    },
    {
...
- Git Checkpoint System incomplete: 2 critical issues
...
- ❌ Production content purity FAILED: 46 blocked items found
   - 17 admin/dev directories
   - 29 blocked files
   REQUIRED ACTION: Remove all admin/dev content before deployment
   See details for complete list of blocked items
- Token budget validation FAILED. Total: 78,764 tokens (Budget: 76,000 tokens). Overage: 2,764 tokens. Deployment BLOCKED until optimization completes.
