...
**Message:** Version consistent: 3.2.0
...
```json
{
  ...
  "issues": [
    ...
    "BLOCKED DIR: .temp-publish/ exists and would be included in production",
    "BLOCKED DIR: .vscode/ exists and would be included in production",
    "BLOCKED DIR: site/ exists and would be included in production",
