...
```json
{
  ...
  "issues": [
    ...
    "BLOCKED FILE: .publish-checkpoint.json must be excluded from production"
  ],
...
**Message:** TDD Mastery integration incomplete: 1 issues (9/10 checks passed). Issues: Cannot import TDDWorkflowOrchestrator: No module named 'src.orchestrators.git_checkpoint_orchestrator'
...
```json
{
  ...
  "issues": [
    "Cannot import TDDWorkflowOrchestrator: No module named 'src.orchestrators.git_checkpoint_orchestrator'"
  ]
}
```
...
**Message:** ❌ Production content purity FAILED: 45 blocked items found
...
```json
{
  ...
  "issues": [
    ...
    "\u26d4 BLOCKED FILE: .publish-checkpoint.json - admin/dev only",
...
**Message:** Token budget validation FAILED. Total: 77,276 tokens (Budget: 76,000 tokens). Overage: 1,276 tokens. Deployment BLOCKED until optimization completes.
...
```json
{
  "timestamp": "2025-12-03T12:29:54.419553",
  "execution_time": 0.003377199172973633,
  "total_current_tokens": 77276,
  "total_budget_tokens": 76000,
  "total_overage_tokens": 1276,
  "is_compliant": false,
  "compliant_count": 3,
  "total_count": 4,
  "files": [
    {
      ...
      "current_tokens": 10826,
      "max_tokens": 12000,
      "char_count": 43307,
      "line_count": 825,
      "is_compliant": true,
      "overage_tokens": -1174,
      "overage_percent": -9.783333333333333,
      "reduction_needed": -10.844263809347867
    },
    {
...
- TDD Mastery integration incomplete: 1 issues (9/10 checks passed). Issues: Cannot import TDDWorkflowOrchestrator: No module named 'src.orchestrators.git_checkpoint_orchestrator'
...
- ❌ Production content purity FAILED: 45 blocked items found
   - 16 admin/dev directories
   - 29 blocked files
   REQUIRED ACTION: Remove all admin/dev content before deployment
   See details for complete list of blocked items
...
- Token budget validation FAILED. Total: 77,276 tokens (Budget: 76,000 tokens). Overage: 1,276 tokens. Deployment BLOCKED until optimization completes.
