...
**Message:** ❌ Production content purity FAILED: 49 blocked items found
...
```json
{
  "timestamp": "2025-12-03T15:13:54.766804",
  "execution_time": 0.000885009765625,
...
- ❌ Production content purity FAILED: 49 blocked items found
   - 18 admin/dev directories
   - 31 blocked files
   REQUIRED ACTION: Remove all admin/dev content before deployment
   See details for complete list of blocked items
