...
**Message:** ❌ Production content purity FAILED: 50 blocked items found
   - 18 admin/dev directories
   - 32 blocked files
...
```json
{
  "blocked_found": {
    ...
    "patterns": [
      "deployment-dry-run-final.log",
      "deployment-dry-run.log",
      "deployment-output.log",
      "epmo_docs_generation.log"
    ]
  },
  "issues": [
    ...
    "\u26d4 BLOCKED DIR: .venv/ exists - MUST be excluded before deployment",
    ...
    "\u26d4 BLOCKED FILE: deployment-dry-run-final.log matches pattern '.*\\.log$'",
    "\u26d4 BLOCKED FILE: deployment-dry-run.log matches pattern '.*\\.log$'",
    ...
    "\u26d4 BLOCKED FILE: deployment-output.log matches pattern '.*\\.log$'",
    "\u26d4 BLOCKED FILE: epmo_docs_generation.log matches pattern '.*\\.log$'",
  ...
  "total_blocked_dirs": 18,
  "total_blocked_files": 32,
  "scan_categories": {
    "admin_dirs": 5,
    "dev_dirs": 1,
    "test_dirs": 5,
...
**Message:** Token budget validation FAILED. Total: 76,343 tokens (Budget: 76,000 tokens). Overage: 343 tokens. Deployment BLOCKED until optimization completes.
...
```json
{
  "timestamp": "2025-12-03T15:24:39.874925",
  "execution_time": 0.0011210441589355469,
  "total_current_tokens": 76343,
  "total_budget_tokens": 76000,
  "total_overage_tokens": 343,
  "is_compliant": false,
  "compliant_count": 3,
  "total_count": 4,
  "files": [
...
- ❌ Production content purity FAILED: 50 blocked items found
   - 18 admin/dev directories
   - 32 blocked files
   REQUIRED ACTION: Remove all admin/dev content before deployment
   See details for complete list of blocked items
...
- Token budget validation FAILED. Total: 76,343 tokens (Budget: 76,000 tokens). Overage: 343 tokens. Deployment BLOCKED until optimization completes.
