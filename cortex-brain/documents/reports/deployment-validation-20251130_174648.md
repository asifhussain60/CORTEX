...
```json
{
  "safe_mocks": [
    ...
    },
    {
      ...
      "pattern": "unittest_mock_import",
      "context": "main_block",
      "snippet": " 429:         \n 430:         # Check if the mock import is inside a string literal (template string)\n 431:         # Pattern: 'from unittest.mock import...' or \"from unittest.mock import...\"\n 432:         if match_line.strip().startswith((\"'from unittest\", '\"from unittest')):\n 433:             # This is a string containing the mock import, not actual import"
    },
    {
      "file": "src/deployment/deployment_gates.py",
      "line": 431,
