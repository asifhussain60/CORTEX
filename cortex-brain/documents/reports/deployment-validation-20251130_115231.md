...
```json
{
  "safe_mocks": [
    ...
    },
    {
      ...
      "pattern": "unittest_mock_import",
      "context": "main_block",
      "snippet": " 420:         \n 421:         # Check if the mock import is inside a string literal (template string)\n 422:         # Pattern: 'from unittest.mock import...' or \"from unittest.mock import...\"\n 423:         if match_line.strip().startswith((\"'from unittest\", '\"from unittest')):\n 424:             # This is a string containing the mock import, not actual import"
    },
    {
      "file": "src\\deployment\\deployment_gates.py",
      "line": 422,
...
**Message:** Production validation passed with warnings: 27 items will be excluded by deploy_cortex.py
