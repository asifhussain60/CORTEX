...
| Mode | Use Case | Log Levels | Overhead | Disk Usage |
|------|----------|------------|----------|------------|
| **Development** | CORTEX internal dev | ALL (TRACE→CRITICAL) | ~1-5ms | ~10MB/1k ops |
| **Production** | End-user deployments | WARNING/ERROR/CRITICAL | ~0.1-0.5ms | ~1MB/1k ops |
| **Hybrid** | User-facing + debugging | INFO/WARNING/ERROR/CRITICAL | ~0.5-2ms | ~3MB/1k ops |
...
|---------|------|----------|---------|
| **CORE-032** | Audit-First Enforcement | blocked | All operations MUST use @audit_driven |
| **CORE-033** | Evidence Verification | blocked | AC-ID 'implemented' MUST have audit proof |
...
| **3** | Feature Orchestrators | 1 | Not Started | Phase 2 |
| **4** | Intelligence & Planning | 1 | Not Started | Phase 3 |
| **4.5** | Extended Intelligence | 1 | Not Started | Phase 4 |
| **5** | Analysis & Knowledge | 1 | Not Started | Phase 4.5 |
| **10** | Production Readiness | 1 | Not Started | Phase 5 |
| **11** | CORTEX LENS | 20 | Not Started | Phase 10 |

**Current Progress:** 36/110 ACs implemented (32.7%)  
...
**How:** Redis (0-7 days) → SQLite (7-30 days) → JSONL.gz (30+ days)  
...
### Phase 1: Audit Foundation (Week 1-2, Jan 15-28)
**Deliverables:**
...
### Phase 2: Intelligence Layer (Week 3-4, Jan 29 - Feb 11)
**Deliverables:**
...
### Phase 3: Challenger Pipeline (Week 5-6, Feb 12-25)
**Deliverables:**
...
**Success Criteria:**
- Pipeline latency <5s
- Top 3 challenges with confidence scores
...
|--------|--------|---------|-------------|
| **Audit Coverage** | 100% | - | All operations have audit entries |
| **Evidence Verification** | ≥95% | 32.7% | ACs with test evidence |
| **Hallucination Detection** | ≥99% | - | False claims caught |
| **Production Overhead** | <0.5ms | - | Per operation in production mode |
| **Development Overhead** | <5ms | - | Per operation in development mode |
| **Disk Savings** | 90% | - | Production vs development mode |
...
**Testing:** CI/CD matrix [ubuntu-latest, windows-latest, macos-latest]

**Workflow:**
1. Feature branch: `git checkout -b feat/AC-{ID}`
2. Implement + test on local platform (MAC or WIN)
3. Push: `git push origin feat/AC-{ID}`
4. CI/CD validates on BOTH platforms
5. Merge after cross-platform tests pass
...
**Files:** 23 SKULL rules in `core-rules.yaml` (1601 lines)
