...
- [ ] **Build Comment Extractor** - `scripts/comment_extractor.py` (Option A implementation)
  ...
  - [ ] **Comment Classification** - Categorize by business relevance
    - [ ] **Critical:** Regulatory references (IRS Pub 969, HIPAA §164.312, PCI-DSS)
    - [ ] **High:** Business rule explanations (eligibility, contribution limits)
    - [ ] **Medium:** Workflow descriptions (claim processing steps)
  ...
  - [ ] **Quality Filters** - Maximize signal-to-noise ratio
    ...
    - [ ] Regulatory keyword detection (IRS, HIPAA, PCI, ERISA, ACA)
    - [ ] Business term matching (grace period, forfeiture, carry over, run-out)
...
- [ ] **Comment Extraction Deliverables**
  ...
  - [ ] Dashboard page: `toolkit/templates/onedrive/developers/developer-insights.html`
    - [ ] Top regulatory comments (IRS/HIPAA citations)
...
- [x] **Section 4:** Core workflows (enrollment, claims, carryover, etc.) ✅
- [x] **Section 5:** Regulatory compliance (IRS, HIPAA, PCI-DSS, ERISA) ✅
...
- [ ] **Section 8:** Developer Insights (NEW - from comment extraction)
  - [ ] Regulatory compliance context (IRS/HIPAA citations from code comments)
...
- [ ] Regulatory keyword index - IRS/HIPAA/PCI-DSS references mapped to files
- [ ] Business term glossary - Extracted from comments (grace period, forfeiture, etc.)
...
- [x] References regulatory requirements with business impact ✅ (IRS Pub 969, HIPAA §164.312)

#### Enhanced Success Criteria (With Comments)
- [ ] Developer tribal knowledge preserved (comments capture "why" decisions were made)
- [ ] Regulatory citations doubled (expect 20+ IRS/HIPAA references from comments)
...
15. **Developer Insights Dashboard** (`toolkit/templates/onedrive/developers/developer-insights.html`) - NEW
    - Top regulatory comments (IRS/HIPAA citations from code)
    ...
    - Regulatory keyword index (IRS Pub 969, HIPAA §164.312 references mapped)
