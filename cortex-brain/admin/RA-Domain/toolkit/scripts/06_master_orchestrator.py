...
class RADomainOrchestrator:
    ...
    def __init__(
        ...
        Args:
            repo_path: Path to Product.ReimbursementAccounts repository
            output_dir: Optional output directory (defaults to cortex-brain/dashboards/data/repos/{repo_name}/)
    ...
    def _load_batch_definitions(self) -> Dict[str, BatchDefinition]:
        ...
        return {
            ...
            '2.5': BatchDefinition(
                ...
                duration_min=60,
                description='External research: IRS/HIPAA/PCI-DSS requirements',
...
def main():
    ...
    parser.add_argument('--repo-path', required=True, help='Path to Product.ReimbursementAccounts')
