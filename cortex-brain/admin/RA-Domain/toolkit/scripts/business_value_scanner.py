...
Purpose: Scan Product.ReimbursementAccounts to identify high-value data points
         for management, team onboarding, and business intelligence.

Target Audience: Engineering Managers, Product Managers, New Team Members
...
class RABusinessValueScanner:
    ...
    def _scan_business_functions(self) -> Dict[str, Any]:
        ...
        services_dir = self.repo_path / 'Libs' / 'Hqy.Member.Domain' / 'Services'
        ...
        jobs_dirs = ['CarryOver.Jobs', 'FlexPlan.Jobs', 'PercentPlanLedger.Jobs']
    ...
    def _extract_business_keywords(self, content: str) -> List[str]:
        ...
        keywords = {
            'carryover', 'rollover', 'forfeiture', 'claim', 'reimbursement',
            'balance', 'plan year', 'enrollment', 'contribution', 'fsa', 'hsa',
            'hra', 'dependent care', 'grace period', 'eligible', 'irs', 'limit',
            'card', 'transaction', 'statement', 'account', 'member', 'employer'
        }
    ...
    def _categorize_capabilities(self, functions: Dict) -> List[Dict[str, Any]]:
        ...
        capability_map = {
            'Account Management': ['Account', 'Balance', 'Enrollment'],
            'Claims Processing': ['Claim', 'Reimbursement', 'AutoPay'],
            'Year-End Processing': ['Carryover', 'Rollover', 'Forfeiture', 'EOFY'],
            'Plan Management': ['Plan', 'FlexPlan', 'PercentPlan'],
            'Card Transactions': ['Card', 'Transaction'],
            'Reporting': ['Statement', 'Report'],
            'Compliance': ['IRS', 'Limit', 'Validation']
        }
    ...
    def _analyze_test_coverage(self) -> Dict[str, Any]:
        ...
        # Analyze by layer
        layers = {
            'Domain': ('Libs/Hqy.Member.Domain', 'Libs/Hqy.Employer.Domain'),
            'Services': ('Services/',),
            'Jobs': ('Apps/CarryOver.Jobs', 'Apps/FlexPlan.Jobs', 'Apps/PercentPlanLedger.Jobs'),
            'Contracts': ('Libs/Hqy.ReimbursementAccounts.Contracts',)
        }
    ...
    def _generate_onboarding_metrics(self) -> Dict[str, Any]:
        ...
        metrics['learning_path'] = [
            ...
            },
            {
                'order': 2,
                'topic': 'Domain Model',
                'description': 'Study entities and relationships (FSA, HSA, HRA, Dependent Care)',
        ...
        metrics['terminology_guide'] = {
            ...
            'Carryover': 'Unused funds transferred to next year',
            'Forfeiture': 'Unused funds returned to employer',
    ...
    def _extract_team_insights(self) -> Dict[str, Any]:
        ...
        insights['maintenance_burden'] = {
            ...
            'risk_areas': ['Carryover Logic', 'Claims Processing', 'Background Jobs']
        }
...
def main():
    ...
    parser.add_argument('--repo-path', default='C:/PROJECTS/Product.ReimbursementAccounts',
