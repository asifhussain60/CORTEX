...
# Parse project file
tree = etree.parse('Hqy.ReimbursementAccounts.CarryOver.Jobs.csproj')
root = tree.getroot()
...
G.add_edge("CarryOver.Jobs", "ApplicationServices")
...
def main():
    repo_path = Path('C:/PROJECTS/Product.ReimbursementAccounts')
