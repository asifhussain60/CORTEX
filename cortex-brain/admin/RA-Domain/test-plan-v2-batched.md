...
**Goal:** Reverse engineer Reimbursement Accounts application through systematic AST scanning and document required AST enhancements.
...
- ✅ Discover and document "Carry Over Logic" business rules
...
3. **Carry Over Logic Documentation** - Business rules, calculations, workflows
...
| 2.5 | 60 min | 3.0 hr | ✅ COMPLETE | External regulatory intelligence (IRS/HIPAA/PCI-DSS) |
...
| 11 | 60 min | 11.42 hr | ⏳ | Plan type analysis (FSA/HSA/HRA/Dependent Care) |
...
| Metric | Value | Impact |
|--------|-------|--------|
| **Root Path** | `C:\PROJECTS\Product.ReimbursementAccounts` | - |
...
| **Library Projects** | 2 (Libs folder) | Hqy.Member.Domain, HealthEquity.Abstractions |
...
**Objective:** Understand ALL functional areas and business domains (not just Carry Over)

### Tasks
- [ ] Read ALL spike/investigation documents in root folder
- [ ] Map all functional areas (Carry Over, Claims, Balances, Ledgers, etc.)
- [ ] Extract business glossary (domain terms, acronyms)
- [ ] Document plan types (FSA, HSA, HRA, Dependent Care, etc.)
- [ ] Map business workflows (enrollment, claims, reimbursement, carry over, forfeiture)
- [ ] Extract business rules from spike documents
- [ ] Identify key stakeholders/user roles
- [ ] Document compliance requirements (HIPAA, IRS, etc.)

### Carry Over Specific Analysis
- [ ] Read `646888-spike-carryover-performance-v2.md` (full document)
- [ ] Find `CarryoverDollarsDomainService.cs` file
- [ ] Extract all methods related to carry over calculation
- [ ] Identify business rules (forfeiture vs carry over)
...
- `discovery/carryover-logic-investigation.md` (UPDATED - business rules added)
- `ast-outputs/carryover-service-methods.json` (method signatures, parameters)
...
**Purpose:** Build deep understanding of healthcare reimbursement accounts (FSA, HSA, HRA) from authentic sources to inform edge case detection, validation rules, and business logic testing.

### Tasks - HealthEquity Domain Knowledge
- ❌ Research HealthEquity's public documentation (deferred - focus on IRS regulations)
- ❌ Study HealthEquity's member portal (deferred)
- ❌ Review HealthEquity's compliance (deferred)
- ❌ Understand HealthEquity's product offerings (deferred)

### Tasks - Healthcare Account Regulations ✅ COMPLETE
- ✅ **IRS Publication 969 (2024/2025)** - FSA/HSA/HRA contribution limits, carryover rules, qualified expenses
  - 2024: FSA $3,200, HSA $4,150/$8,300, Dependent Care $5,000, Catch-up $1,000
  - 2025: HSA $4,300/$8,550 (inflation-indexed)
  - Carryover: FSA $640 max OR 2.5-month grace (mutual exclusion), HSA 100% unlimited
- ✅ **IRS Publication 502** - Qualified medical expenses (11 categories), OTC medicine rules (2019+), preventive care expansion (2024)
- ✅ **26 CFR §125** - Captured in IRS Pub 969 (grace period vs carryover rules)

### Tasks - Compliance & Standards ✅ COMPLETE
- ✅ **HIPAA Security Rule (HHS.gov)** - PHI protection (45 CFR §164.308-312)
...
- ✅ **PCI-DSS v4.0.1 (PCIsecuritystandards.org)** - Payment card data security
...
- ✅ `discovery/external-intelligence-matrix.md` (~400 lines) - Regulations → test scenarios
  - **P0 Gaps Confirmed:** 9 critical issues (no FSA/HSA limit validation, no $640 carryover limit, CVV storage risk, PAN encryption, PHI audit)
...
- ✅ `learning/healthcare-reimbursement/regulatory-compliance-knowledge.md` (~550 lines) - Reusable compliance knowledge
  - **Purpose:** Future healthcare project reference (IRS limits, HIPAA security, PCI-DSS)
  - **Content:** IRS 2024/2025 limits, carryover rules, qualified expenses, HDHP requirements, HIPAA safeguards, PCI-DSS requirements, annual calendar, testing checklists
  - **Version:** 1.0 (Dec 11, 2025) - Next update: Dec 2025 (after IRS announces 2026 limits)

### Knowledge Application Strategy ✅ APPLIED
**Using gathered intelligence to:**
1. ✅ **Validate business logic** - IRS limits mapped to code validation requirements (P0 gap confirmed)
2. ✅ **Generate edge case tests** - 40+ test scenarios from IRS/HIPAA/PCI-DSS regulations
3. ✅ **Identify compliance gaps** - 9 P0 issues, 6 P1 issues documented
4. ✅ **Inform P0-P3 issue detection** - Regulatory impact drives priority (IRS violations = P0)
5. ✅ **Create realistic test data** - 2024/2025 limits documented for test generation
6. ✅ **Design validation rules** - IRS-compliant validation logic specified

### Verified Sources (All Official/Public) ✅
**Official Sources Used:**
- ✅ **IRS.gov** - Publications 969 (2024/2025), 502
- ✅ **HHS.gov** - HIPAA Security Rule (45 CFR Part 164)
- ✅ **PCIsecuritystandards.org** - PCI-DSS v4.0.1

**Legal Compliance:** ✅ All sources official government/industry sites - NO pirated content, NO unauthorized PDFs

### Success Criteria ✅ ALL MET
- ✅ Documented IRS contribution limits for 2024 & 2025
- ✅ Mapped 40+ regulatory test scenarios (exceeds 20+ target)
- ✅ Identified HIPAA/PCI-DSS requirements applicable to codebase
...
### Key Findings
**Critical Discovery:** Code MUST validate IRS contribution limits - not found in Batch 1 AST scan (P0 compliance gap)

**Regulatory Validation Points:**
- FSA: $3,200 annual max (2024), $640 carryover max OR 2.5-month grace (not both)
- HSA: $4,150/$8,300 (2024), $4,300/$8,550 (2025), $1,000 catch-up age 55+, 100% unlimited rollover
- Dependent Care: $5,000 annual max, $0 carryover (use-it-or-lose-it strict)
- HDHP: $1,600/$3,200 min deductible (2024), $8,050/$16,100 max OOP (2024)

**Security Requirements:**
- HIPAA: PHI audit trail, MFA, encryption at rest/transit, session timeout 10-15 min, RBAC
- PCI-DSS: NEVER store CVV/PIN, encrypt PAN AES-256, mask display (last 4 only), tokenize for storage
...
- [ ] Categorize by business domain (Account, Member, Plan, Transaction, etc.)
- [ ] Identify base entity classes
- [ ] Map inheritance hierarchy

### Sub-Batch 3.2: Account-Related Entities (15 mins)
- [ ] Extract ReimbursementAccount entity
...
### Sub-Batch 3.3: Member/Plan Entities (15 mins)
- [ ] Extract Member-related entities (batch 2 of ~9 files)
...
- `domain-models/carry-over-entities.md` (specific to carry over logic)
...
### Sub-Batch 4.2: Account/Member DTOs (15 mins)
- [ ] Extract Account-related DTOs (batch 1 of ~9 files)
- [ ] Extract Member-related DTOs
- [ ] Map validation attributes
- [ ] Identify API versioning patterns

### Sub-Batch 4.3: Transaction/Claims DTOs (15 mins)
- [ ] Extract Transaction DTOs (batch 2 of ~9 files)
- [ ] Extract Claims DTOs
- [ ] Document calculation fields
- [ ] Map nested DTO structures

### Sub-Batch 4.4: Carry Over & Specialized DTOs (15 mins)
- [ ] Extract Carry Over DTOs (batch 3 of ~9 files)
...
### Tasks
- [ ] Analyze `Hqy.ReimbursementAccounts.CarryOver.Jobs`
- [ ] Analyze `Hqy.ReimbursementAccounts.FlexPlan.Jobs`
- [ ] Analyze `Hqy.ReimbursementAccounts.PercentPlanLedger.Jobs`
...
### Tasks
- [ ] Analyze `Hqy.CarryoverTransferTracking.Endpoint`
...
**Execution Command:**
```powershell
cd C:\PROJECTS\Product.ReimbursementAccounts\Apps\Hqy.CarryoverTransferTracking.Endpoint
```
...
### Tasks
- [ ] Scan `Hqy.ReimbursementAccounts.ApplicationServices`
...
**Execution Command:**
```powershell
cd C:\PROJECTS\Product.ReimbursementAccounts\Apps\Hqy.ReimbursementAccounts.ApplicationServices
```
...
### Tasks
- [ ] Group services by functional area (Carry Over, Claims, Balances, etc.)
...
**Execution Command:**
```powershell
cd C:\PROJECTS\Product.ReimbursementAccounts\Tests
```
...
### Tasks
- [ ] Extract calculation methods (balances, carry over, forfeiture)
...
- [ ] Detect race conditions in parallel code (carry over batch processing)
...
- External domain intelligence gathering (IRS regulations, industry patterns)
...
1. **Domain Discovery Orchestrator** (HIGH priority)
   ...
   - **NEW:** Integrates external domain research (IRS, HIPAA, industry standards)

2. **External Intelligence Gatherer** (HIGH priority)
   - Fetches authoritative domain knowledge from web sources
   - Extracts regulations from IRS.gov, compliance standards
...
3. **Language Processor Orchestrator** (HIGH priority)
   ...
   - Enriches with external authoritative sources (IRS, HIPAA, industry)
...
- [ ] External Source: {IRS/HIPAA/Industry regulation used}
...
| 12. Plan Types | ⏳ | 60 min | FSA/HSA/HRA | - | - |
...
- ✅ Purpose: Test AST→business language on single entity (ReimbursementAccount)
...
- ✅ Technology: spaCy (NLP), BeautifulSoup (IRS scraping), basic semantic mapping

**Previous Updates:**
- ✅ Added Batch 2.5: External Domain Intelligence Gathering (60 min)
- ✅ Purpose: Fetch IRS regulations, HIPAA/PCI-DSS compliance, industry best practices
...
- ✅ Sources: IRS.gov, HealthEquity.com, HHS.gov, industry research
...
**Purpose:** Make RA domain analysis accessible through CORTEX admin dashboard under new repo: `reimbursement-accounts`

### Tasks - Repository Setup
- [ ] Create `cortex-brain/dashboards/data/repos/reimbursement-accounts/` folder
...
- [ ] **business-domain.json** - NEW schema for healthcare domain
  - Plan types: FSA, HSA, HRA, Dependent Care FSA (from plan-types-comprehensive.md)
  ...
  - Regulatory compliance: IRS limits, HIPAA, PCI-DSS from regulatory-compliance-knowledge.md
...
- [ ] **security.json** - Security findings
  ...
  - HIPAA compliance gaps: PHI audit trail, MFA, encryption, session timeout
  - PCI-DSS gaps: CVV storage risk, PAN encryption, masking
...
- [ ] **regulatory-compliance.json** - NEW schema for healthcare compliance
  - IRS regulations: 2024/2025 contribution limits, carryover rules
  - HIPAA requirements: administrative/technical/physical safeguards
  - PCI-DSS requirements: 12 requirements, CHD protection
  - Compliance test scenarios: 40+ from external-intelligence-matrix.md
  - Validation checkpoints: IRS limit enforcement, PHI audit, PAN encryption

### Tasks - Specialized Data Files
- [ ] **carryover-logic.json** - Carry Over Logic documentation
  - Service methods: 20 from carryover-service-methods.json
  - Business rules: from carryover-logic-investigation.md
  - IRS regulations: $640 FSA max, grace period mutual exclusion
  - Entities: carryover-related entities from Batch 3-6
...
- [ ] **business-intelligence.json** - External domain knowledge
  - IRS sources: Publications 969, 502
  - HIPAA sources: HHS.gov guidance
  - PCI-DSS sources: PCIsecuritystandards.org v4.0.1
...
### Expected Outputs (All in `cortex-brain/dashboards/data/repos/reimbursement-accounts/`)
...
- `security.json` - Security findings (P0 gaps, HIPAA, PCI-DSS)
- `health-data.json` - Code quality metrics (P0-P3 issues, technical debt)
- `regulatory-compliance.json` - Compliance requirements (IRS, HIPAA, PCI-DSS)
- `carryover-logic.json` - Carry Over Logic documentation
...
- ✅ Carryover logic and AST enhancements documented
...
- **Regulatory Tracking:** Dedicated compliance view (IRS limits, HIPAA, PCI-DSS)
- **Future Updates:** Annual IRS limit updates (Dec 2025 → refresh compliance data)
...
- `regulatory-compliance.schema.json` (IRS, HIPAA, PCI-DSS requirements)
