# Diagram 03: CORTEX Plugin Architecture (Hub-and-Spoke)
...
- Tier 0 (innermost): 80px diameter, #6B46C1 fill
- Tier 1: 160px diameter, #3B82F6 fill, 70% opacity
- Tier 2: 240px diameter, #10B981 fill, 50% opacity
- Tier 3 (outermost): 320px diameter, #F59E0B fill, 30% opacity
...
- Style: 3px solid lines, #10B981 color
...
**Icon Style:** 60×60px, flat design, outlined, #10B981 color
