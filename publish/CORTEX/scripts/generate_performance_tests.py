"""Generate performance regression test file."""
...
# Write to file
output_path = Path(__file__).parent.parent / "tests" / "performance" / "test_performance_regression.py"
output_path.write_text(test_content, encoding='utf-8')
print(f"✅ Generated: {output_path}")
print(f"📏 Size: {len(test_content)} bytes")
print(f"🧪 Tests: 11 performance regression tests")
